...
public final class ScopeSetExtKt {
    public static /* synthetic */ Pair fragment$default(ScopeDSL $this$fragment_u24default, Qualifier qualifier, Function2 definition, int i, Object obj) {
    ...
    public static final /* synthetic */ <T extends Fragment> Pair<Module, InstanceFactory<T>> fragment(ScopeDSL $this$fragment, Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> definition) {
    ...
    public static /* synthetic */ Pair fragment$default(ScopeDSL $this$fragment_u24default, Qualifier qualifier, int i, Object obj) {
        Qualifier qualifier2;
        if ((i & 1) == 0) {
            qualifier2 = qualifier;
        } else {
        ...
        Function2 definition$iv = new ScopeSetExtKt$fragment$1();
        Module this_$iv$iv = $this$fragment_u24default.getModule();
        Qualifier scopeQualifier$iv$iv = $this$fragment_u24default.getScopeQualifier();
        Kind kind$iv$iv$iv = Kind.Factory;
        List secondaryTypes$iv$iv$iv = CollectionsKt.emptyList();
    ...
    @KoinReflectAPI
    public static final /* synthetic */ <T extends Fragment> Pair<Module, InstanceFactory<T>> fragment(ScopeDSL $this$fragment, Qualifier qualifier) {
        Intrinsics.checkNotNullParameter($this$fragment, "<this>");
        Intrinsics.needClassReification();
        Function2 definition$iv = new ScopeSetExtKt$fragment$1();
        Module this_$iv$iv = $this$fragment.getModule();
