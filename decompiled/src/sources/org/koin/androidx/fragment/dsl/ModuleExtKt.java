...
public final class ModuleExtKt {
    public static /* synthetic */ Pair fragment$default(Module $this$fragment_u24default, Qualifier qualifier, Function2 definition, int i, Object obj) {
        ...
        Module.saveMapping$default($this$fragment_u24default, mapping$iv$iv, instanceFactory$iv$iv, false, 4, null);
        return new Pair($this$fragment_u24default, instanceFactory$iv$iv);
    }

    public static final /* synthetic */ <T extends Fragment> Pair<Module, InstanceFactory<T>> fragment(Module $this$fragment, Qualifier qualifier, Function2<? super Scope, ? super ParametersHolder, ? extends T> definition) {
        ...
        FactoryInstanceFactory instanceFactory$iv$iv = new FactoryInstanceFactory(def$iv$iv);
        Module.saveMapping$default($this$fragment, mapping$iv$iv, instanceFactory$iv$iv, false, 4, null);
        return new Pair<>($this$fragment, instanceFactory$iv$iv);
    }

    public static /* synthetic */ Pair fragment$default(Module $this$fragment_u24default, Qualifier qualifier, int i, Object obj) {
        Qualifier qualifier2;
        if ((i & 1) == 0) {
            qualifier2 = qualifier;
        } else {
        ...
        Function2 definition$iv = new ModuleExtKt$fragment$1();
        Qualifier scopeQualifier$iv$iv = ScopeRegistry.INSTANCE.getRootScopeQualifier();
        Kind kind$iv$iv$iv = Kind.Factory;
        List secondaryTypes$iv$iv$iv = CollectionsKt.emptyList();
        Intrinsics.reifiedOperationMarker(4, "T");
    ...
    @KoinReflectAPI
    public static final /* synthetic */ <T extends Fragment> Pair<Module, InstanceFactory<T>> fragment(Module $this$fragment, Qualifier qualifier) {
        Intrinsics.checkNotNullParameter($this$fragment, "<this>");
        Intrinsics.needClassReification();
        Function2 definition$iv = new ModuleExtKt$fragment$1();
        Qualifier scopeQualifier$iv$iv = ScopeRegistry.INSTANCE.getRootScopeQualifier();
