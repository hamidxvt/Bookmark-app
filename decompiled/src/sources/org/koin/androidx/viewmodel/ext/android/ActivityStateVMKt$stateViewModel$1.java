...
public final class ActivityStateVMKt$stateViewModel$1 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public ActivityStateVMKt$stateViewModel$1(Qualifier qualifier, Function0<? extends ParametersHolder> function0, Function0<Bundle> function02, Scope scope, ComponentActivity componentActivity) {
        super(0);
    ...
    public final ViewModelProvider.Factory invoke() {
        ...
        Function0 owner = new Function0<ViewModelOwner>() { // from class: org.koin.androidx.viewmodel.ext.android.ActivityStateVMKt$stateViewModel$1$owner$1
            {
                super(0);
            }
