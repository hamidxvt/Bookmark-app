...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    private static void reflectionAppend(Object object, Class<?> clazz, HashCodeBuilder builder, boolean useTransients, String[] excludeFields) {
        ...
        try {
            register(object);
            Field[] fields = (Field[]) ArraySorter.sort(clazz.getDeclaredFields(), Comparator.comparing(new Function() { // from class: org.apache.commons.lang3.builder.HashCodeBuilder$$ExternalSyntheticLambda0
