            ...
            while (true) {
                ...
                if (millisecs3 < length2) {
                    ...
                    if (!offsetSet) {
                        ...
                        int max2 = val.getActualMaximum(aField[0]);
                        int offset3 = val.get(aField[0]) - min;
                        boolean z = offset3 > (max2 - min) / 2;
                        max = offset3;
                        roundUp = z;
                    }
                    if (max != 0) {
                        val.set(aField[0], val.get(aField[0]) - max);
                    }
                    i++;
                    modifyType = modType;
