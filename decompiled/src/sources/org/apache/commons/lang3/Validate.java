...
public class Validate {
    ...
    public static <T> T notNull(T t, final String str, final Object... objArr) {
        return (T) Objects.requireNonNull(t, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda2
    ...
    public static <T> T[] notEmpty(T[] array, final String message, final Object... values) {
        Objects.requireNonNull(array, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda5
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(message, values);
                return format;
            }
        });
        if (array.length == 0) {
    ...
    public static <T extends Collection<?>> T notEmpty(T collection, final String message, final Object... values) {
        Objects.requireNonNull(collection, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda4
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(message, values);
    ...
    public static <T extends Map<?, ?>> T notEmpty(T map, final String message, final Object... values) {
        Objects.requireNonNull(map, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(message, values);
    ...
    public static <T extends CharSequence> T notEmpty(T chars, final String message, final Object... values) {
        Objects.requireNonNull(chars, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda3
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(message, values);
    ...
    public static <T extends CharSequence> T notBlank(T chars, final String message, final Object... values) {
        Objects.requireNonNull(chars, (Supplier<String>) new Supplier() { // from class: org.apache.commons.lang3.Validate$$ExternalSyntheticLambda1
            @Override // java.util.function.Supplier
            public final Object get() {
                String format;
                format = String.format(message, values);
