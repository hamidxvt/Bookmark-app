...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m569constructorimpl = Result.m569constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final Throwable safeCtor$lambda$9(Function1 $block, Throwable e) {
        ...
        try {
            ...
            m569constructorimpl = Result.m569constructorimpl(result);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m569constructorimpl = Result.m569constructorimpl(ResultKt.createFailure(th));
        }
        return (Throwable) (Result.m575isFailureimpl(m569constructorimpl) ? null : m569constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m569constructorimpl = Result.m569constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m569constructorimpl = Result.m569constructorimpl(ResultKt.createFailure(th));
        }
        ...
        return ((Number) m569constructorimpl).intValue();
    }
