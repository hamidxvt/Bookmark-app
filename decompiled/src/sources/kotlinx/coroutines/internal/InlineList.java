...
public final class InlineList<E> {
    ...
    public static <E> Object m2120constructorimpl(Object obj) {
        return obj;
    }
    ...
    public boolean equals(Object other) {
        return m2122equalsimpl(this.holder, other);
    }
    ...
    public static /* synthetic */ Object m2121constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
    ...
    public static final Object m2126plusFjFbRPM(Object arg0, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && (e instanceof List)) {
            throw new AssertionError();
        }
        if (arg0 == null) {
            return m2120constructorimpl(e);
        }
        if (arg0 instanceof ArrayList) {
            ...
            return m2120constructorimpl(arg0);
        }
        ArrayList list = new ArrayList(4);
        list.add(arg0);
        list.add(e);
        return m2120constructorimpl(list);
    }
