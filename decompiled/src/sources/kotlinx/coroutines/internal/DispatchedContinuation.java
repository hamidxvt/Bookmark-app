...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(getContext())) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo2130dispatch(getContext(), this);
            return;
        }
        if (DebugKt.getASSERTIONS_ENABLED()) {
        }
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(12:13|(2:14|15)|(3:74|75|(10:77|78|18|(14:20|21|22|(2:59|60)(1:24)|25|26|27|28|29|30|31|32|(1:45)|36)(1:72)|37|(2:44|38)|40|41|42|43))|17|18|(0)(0)|37|(1:38)|40|41|42|43) */
    ...
    /* JADX WARN: Removed duplicated region for block: B:44:? A[LOOP:0: B:38:0x0127->B:44:?, LOOP_END, SYNTHETIC] */
    ...
    */
    public final void resumeCancellableWith$kotlinx_coroutines_core(Object result) {
        ...
        if (job$iv != null) {
            ...
            if (!job$iv.isActive()) {
                ...
                resumeWith(Result.m569constructorimpl(ResultKt.createFailure(cause$iv)));
                z = true;
                if (z) {
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        if (job != null && !job.isActive()) {
            ...
            Result.Companion companion = Result.INSTANCE;
            resumeWith(Result.m569constructorimpl(ResultKt.createFailure(cause)));
            return true;
        }
        return false;
    }
