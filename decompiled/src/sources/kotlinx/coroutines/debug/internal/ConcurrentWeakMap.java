...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:22:0x0086, code lost:
            ...
            if (com.google.common.util.concurrent.Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(getValues(), r0, r1, r13) == false) goto L52;
         */
        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (w != null) {
                    ...
                    if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(getKeys(), index, null, weakKey)) {
                        break;
                    }
                }
            }
