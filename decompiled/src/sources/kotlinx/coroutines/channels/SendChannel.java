...
public interface SendChannel<E> {
    ...
    Object mo2064trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo2064trySendJP2dKIU(e);
            if (ChannelResult.m2089isSuccessimpl(result)) {
                return true;
            }
            Throwable m2083exceptionOrNullimpl = ChannelResult.m2083exceptionOrNullimpl(result);
