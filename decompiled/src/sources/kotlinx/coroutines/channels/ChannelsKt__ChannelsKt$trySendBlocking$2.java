        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    r = Result.m569constructorimpl(ResultKt.createFailure(th));
                    return ChannelResult.m2079boximpl(!Result.m576isSuccessimpl(r) ? ChannelResult.INSTANCE.m2094successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2092closedJP2dKIU(Result.m572exceptionOrNullimpl(r)));
                }
                if (sendChannel.send(e, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                r = Result.m569constructorimpl(Unit.INSTANCE);
                return ChannelResult.m2079boximpl(!Result.m576isSuccessimpl(r) ? ChannelResult.INSTANCE.m2094successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2092closedJP2dKIU(Result.m572exceptionOrNullimpl(r)));
            case 1:
                try {
                    ResultKt.throwOnFailure($result);
