...
public interface ReceiveChannel<E> {
    ...
    Object mo2071receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2072tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo2072tryReceivePtdJZtk = receiveChannel.mo2072tryReceivePtdJZtk();
            if (ChannelResult.m2089isSuccessimpl(mo2072tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2085getOrThrowimpl(mo2072tryReceivePtdJZtk);
            }
            Throwable m2083exceptionOrNullimpl = ChannelResult.m2083exceptionOrNullimpl(mo2072tryReceivePtdJZtk);
            if (m2083exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m2083exceptionOrNullimpl);
        }
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (receiveChannel$receiveOrNull$1.label) {
                        case 0:
                            ...
                            mo2071receiveCatchingJP2dKIU = receiveChannel.mo2071receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        ...
                        case 1:
                            ResultKt.throwOnFailure($result);
                            mo2071receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                            break;
                        default:
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    return ChannelResult.m2084getOrNullimpl(mo2071receiveCatchingJP2dKIU);
                }
            }
