...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2071receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2071receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2072tryReceivePtdJZtk() {
        return this._channel.mo2072tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2064trySendJP2dKIU(E e) {
        return this._channel.mo2064trySendJP2dKIU(e);
    }
