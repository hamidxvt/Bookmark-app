                    ...
                    try {
                        if (job == null || job.isActive()) {
                            ...
                            if (exception != null) {
                                ...
                                continuation.resumeWith(Result.m569constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                            }
                        } else {
                            ...
                            if (!DebugKt.getRECOVER_STACK_TRACES()) {
                                ...
                                continuation.resumeWith(Result.m569constructorimpl(ResultKt.createFailure(cancellationException)));
                            }
