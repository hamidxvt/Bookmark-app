...
final class FlowKt__DelayKt$timeoutInternal$1$1$1<T> extends SuspendLambda implements Function2<ChannelResult<? extends T>, Continuation<? super Boolean>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Continuation<? super Boolean> continuation) {
        return m2111invokeWpGqRn0(((ChannelResult) obj).getHolder(), continuation);
    }

    /* renamed from: invoke-WpGqRn0, reason: not valid java name */
    public final Object m2111invokeWpGqRn0(Object obj, Continuation<? super Boolean> continuation) {
        return ((FlowKt__DelayKt$timeoutInternal$1$1$1) create(ChannelResult.m2079boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        switch (this.label) {
            case 0:
                ...
                if (!(obj3 instanceof ChannelResult.Closed)) {
                    Throwable m2083exceptionOrNullimpl = ChannelResult.m2083exceptionOrNullimpl(obj3);
