                ...
                if ((sharedFlowImpl$collect$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (sharedFlowImpl$collect$1.label) {
                        case 0:
                            ...
                            SharedFlowSlot allocateSlot = sharedFlowImpl2.allocateSlot();
                            ...
                            } while (sharedFlowImpl2.awaitValue((SharedFlowSlot) flowCollector, sharedFlowImpl$collect$1) != coroutine_suspended);
                            return coroutine_suspended;
                        case 1:
                        ...
                        case 2:
                            ...
                            r3 = (FlowCollector) sharedFlowImpl$collect$1.L$1;
                            sharedFlowImpl2 = (SharedFlowImpl) sharedFlowImpl$collect$1.L$0;
                            ResultKt.throwOnFailure(obj);
                            do {
                                tryTakeValue = sharedFlowImpl2.tryTakeValue((SharedFlowSlot) flowCollector);
                        ...
                        case 3:
                            ...
                            boolean z = (FlowCollector<? super T>) ((SharedFlowSlot) sharedFlowImpl$collect$1.L$2);
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation cont : continuationArr) {
            if (cont != null) {
                ...
                cont.resumeWith(Result.m569constructorimpl(Unit.INSTANCE));
            }
        }
        return emitted;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation r : continuationArr) {
            if (r != null) {
                ...
                r.resumeWith(Result.m569constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    */
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        for (Continuation resume : continuationArr) {
            if (resume != null) {
                Result.Companion companion = Result.INSTANCE;
                resume.resumeWith(Result.m569constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
