    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                holder = resultChannel.mo2071receiveCatchingJP2dKIU(combineKt$combineInternal$2);
                if (holder == coroutine_suspended) {
                    return coroutine_suspended;
                }
                latestValues2 = latestValues;
                element = (IndexedValue) ChannelResult.m2084getOrNullimpl(holder);
                if (element != null) {
                    return Unit.INSTANCE;
                }
                do {
                    ...
                    if (lastReceivedEpoch[index] != remainingAbsentValues) {
                        ...
                        element = (IndexedValue) ChannelResult.m2084getOrNullimpl(resultChannel.mo2072tryReceivePtdJZtk());
                    }
