...
public final class FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1", f = "Emitters.kt", i = {0, 0, 1, 2}, l = {BuildConfig.VERSION_CODE, 117, 124}, m = "collect", n = {"this", "$this$onCompletion_u24lambda_u242", "e", "sc"}, s = {"L$0", "L$1", "L$0", "L$0"})
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        try {
                ...
                if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    switch (anonymousClass1.label) {
                        case 0:
                            ...
                            anonymousClass1.L$1 = $this$onCompletion_u24lambda_u242;
                            anonymousClass1.label = 1;
                            if (flow.collect($this$onCompletion_u24lambda_u242, anonymousClass1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            sc = new SafeCollector($this$onCompletion_u24lambda_u242, anonymousClass1.getContext());
                            try {
                                ...
                                InlineMarker.mark(6);
                                invoke = function3.invoke(sc, null, anonymousClass1);
                                InlineMarker.mark(7);
                        ...
                        case 1:
                            $this$onCompletion_u24lambda_u242 = (FlowCollector) anonymousClass1.L$1;
                            ...
                            anonymousClass1.label = 3;
                            InlineMarker.mark(6);
                            invoke = function32.invoke(sc, null, anonymousClass1);
                            InlineMarker.mark(7);
                            if (invoke != coroutine_suspended) {
                            }
                            break;
            ...
            invokeSafely$FlowKt__EmittersKt = FlowKt__EmittersKt.invokeSafely$FlowKt__EmittersKt(throwingCollector, function33, e2, anonymousClass1);
