...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m737boximpl(ULong.m743constructorimpl(getMostSignificantBits())), ULong.m737boximpl(ULong.m743constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2048fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$0(Uuid a, Uuid b) {
        ...
        if (a.mostSignificantBits != b.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m743constructorimpl(a.mostSignificantBits), ULong.m743constructorimpl(b.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m743constructorimpl(a.leastSignificantBits), ULong.m743constructorimpl(b.leastSignificantBits));
    }
}
