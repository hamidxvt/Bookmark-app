...
public final class URandomKt {
    public static final int nextUInt(Random $this$nextUInt) {
        ...
        return UInt.m664constructorimpl($this$nextUInt.nextInt());
    }

    /* renamed from: nextUInt-qCasIEU, reason: not valid java name */
    public static final int m1797nextUIntqCasIEU(Random nextUInt, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        return m1796nextUInta8DCA5k(nextUInt, 0, until);
    }

    /* renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m1796nextUInta8DCA5k(Random nextUInt, int from, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        m1791checkUIntRangeBoundsJ1ME1BU(from, until);
        ...
        return UInt.m664constructorimpl(signedResult);
    }
    ...
    public static final int nextUInt(Random $this$nextUInt, UIntRange range) {
        ...
        return Integer.compareUnsigned(range.getLast(), -1) < 0 ? m1796nextUInta8DCA5k($this$nextUInt, range.getFirst(), UInt.m664constructorimpl(range.getLast() + 1)) : Integer.compareUnsigned(range.getFirst(), 0) > 0 ? UInt.m664constructorimpl(m1796nextUInta8DCA5k($this$nextUInt, UInt.m664constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt($this$nextUInt);
    }

    public static final long nextULong(Random $this$nextULong) {
        Intrinsics.checkNotNullParameter($this$nextULong, "<this>");
        return ULong.m743constructorimpl($this$nextULong.nextLong());
    }

    /* renamed from: nextULong-V1Xi4fY, reason: not valid java name */
    public static final long m1798nextULongV1Xi4fY(Random nextULong, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        return m1799nextULongjmpaWc(nextULong, 0L, until);
    }

    /* renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m1799nextULongjmpaWc(Random nextULong, long from, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        m1792checkULongRangeBoundseb3DHEI(from, until);
        ...
        return ULong.m743constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (Long.compareUnsigned(range.getLast(), -1L) < 0) {
            return m1799nextULongjmpaWc($this$nextULong, range.getFirst(), ULong.m743constructorimpl(range.getLast() + ULong.m743constructorimpl(1 & 4294967295L)));
        }
        if (Long.compareUnsigned(range.getFirst(), 0L) <= 0) {
            return nextULong($this$nextULong);
        }
        long j = 1 & 4294967295L;
        return ULong.m743constructorimpl(m1799nextULongjmpaWc($this$nextULong, ULong.m743constructorimpl(range.getFirst() - ULong.m743constructorimpl(j)), range.getLast()) + ULong.m743constructorimpl(j));
    }

    /* renamed from: nextUBytes-EVgfTAA, reason: not valid java name */
    public static final byte[] m1793nextUBytesEVgfTAA(Random nextUBytes, byte[] array) {
    ...
    public static final byte[] nextUBytes(Random $this$nextUBytes, int size) {
        ...
        return UByteArray.m640constructorimpl($this$nextUBytes.nextBytes(size));
    }

    /* renamed from: nextUBytes-Wvrt4B4$default, reason: not valid java name */
    public static /* synthetic */ byte[] m1795nextUBytesWvrt4B4$default(Random random, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m1794nextUBytesWvrt4B4(random, bArr, i, i2);
    }

    /* renamed from: nextUBytes-Wvrt4B4, reason: not valid java name */
    public static final byte[] m1794nextUBytesWvrt4B4(Random nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkNotNullParameter(array, "array");
    ...
    public static final void m1791checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(Integer.compareUnsigned(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m658boximpl(from), UInt.m658boximpl(until)).toString());
        }
    }

    /* renamed from: checkULongRangeBounds-eb3DHEI, reason: not valid java name */
    public static final void m1792checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(Long.compareUnsigned(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m737boximpl(from), ULong.m737boximpl(until)).toString());
        }
    }
}
