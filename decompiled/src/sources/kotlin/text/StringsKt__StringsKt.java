...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final boolean toBooleanStrict(String $this$toBooleanStrict) {
        ...
        if (Intrinsics.areEqual($this$toBooleanStrict, BooleanUtils.TRUE)) {
            return true;
        }
        if (Intrinsics.areEqual($this$toBooleanStrict, BooleanUtils.FALSE)) {
            return false;
        }
    ...
    public static final Boolean toBooleanStrictOrNull(String $this$toBooleanStrictOrNull) {
        ...
        if (Intrinsics.areEqual($this$toBooleanStrictOrNull, BooleanUtils.TRUE)) {
            return true;
        }
        return Intrinsics.areEqual($this$toBooleanStrictOrNull, BooleanUtils.FALSE) ? false : null;
    }
}
