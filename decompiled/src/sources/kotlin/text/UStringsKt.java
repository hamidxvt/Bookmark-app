...
public final class UStringsKt {
    ...
    public static final String m1901toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1903toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1902toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
        return UnsignedKt.ulongToString($this$toString_u2dV7xB4Y4 & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m1900toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m664constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m664constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m844boximpl(UShort.m850constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m664constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m664constructorimpl(result * uradix);
            result = UInt.m664constructorimpl(UInt.m664constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m658boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m743constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m743constructorimpl(result * uradix);
            result = ULong.m743constructorimpl(ULong.m743constructorimpl(UInt.m664constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m737boximpl(result);
    }
}
