...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final byte coerceIn(byte $this$coerceIn, byte minimumValue, byte maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((int) maximumValue) + " is less than minimum " + ((int) minimumValue) + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
    ...
    public static final int coerceIn(int $this$coerceIn, int minimumValue, int maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + maximumValue + " is less than minimum " + minimumValue + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
