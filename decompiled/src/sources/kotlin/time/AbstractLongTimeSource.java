...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1905minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m1909minusLRDsOJo(this, duration);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: elapsedNow-UwyO8pc */
        public long mo1904elapsedNowUwyO8pc() {
            return Duration.m1942minusLRDsOJo(LongSaturatedMathKt.saturatingOriginsDiff(this.timeSource.adjustedRead(), this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo */
        public ComparableTimeMark mo1907plusLRDsOJo(long duration) {
            DurationUnit unit = this.timeSource.getUnit();
            if (Duration.m1939isInfiniteimpl(duration)) {
                return new LongTimeMark(LongSaturatedMathKt.m2013saturatingAddNuflL3o(this.startedAt, unit, duration), this.timeSource, Duration.INSTANCE.m2005getZEROUwyO8pc(), null);
            }
            long durationInUnit = Duration.m1957truncateToUwyO8pc$kotlin_stdlib(duration, unit);
            long rest = Duration.m1943plusLRDsOJo(Duration.m1942minusLRDsOJo(duration, durationInUnit), this.offset);
            long sum = LongSaturatedMathKt.m2013saturatingAddNuflL3o(this.startedAt, unit, durationInUnit);
            long restInUnit = Duration.m1957truncateToUwyO8pc$kotlin_stdlib(rest, unit);
            long sum2 = LongSaturatedMathKt.m2013saturatingAddNuflL3o(sum, unit, restInUnit);
            long restUnderUnit = Duration.m1942minusLRDsOJo(rest, restInUnit);
            long restUnderUnitNs = Duration.m1927getInWholeNanosecondsimpl(restUnderUnit);
            if (sum2 != 0 && restUnderUnitNs != 0 && (sum2 ^ restUnderUnitNs) < 0) {
                ...
                sum2 = LongSaturatedMathKt.m2013saturatingAddNuflL3o(sum2, unit, correction);
                restUnderUnit = Duration.m1942minusLRDsOJo(restUnderUnit, correction);
            }
            long newValue = sum2;
            long newOffset = (((newValue - 1) | 1) > Long.MAX_VALUE ? 1 : (((newValue - 1) | 1) == Long.MAX_VALUE ? 0 : -1)) == 0 ? Duration.INSTANCE.m2005getZEROUwyO8pc() : restUnderUnit;
        ...
        public long mo1906minusUwyO8pc(ComparableTimeMark other) {
            ...
            return Duration.m1943plusLRDsOJo(startedAtDiff, Duration.m1942minusLRDsOJo(this.offset, ((LongTimeMark) other).offset));
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof LongTimeMark) && Intrinsics.areEqual(this.timeSource, ((LongTimeMark) other).timeSource) && Duration.m1919equalsimpl0(mo1906minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m2005getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return (Duration.m1935hashCodeimpl(this.offset) * 37) + Long.hashCode(this.startedAt);
        }

        public String toString() {
            return "LongTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1954toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new LongTimeMark(adjustedRead(), this, Duration.INSTANCE.m2005getZEROUwyO8pc(), null);
    }
}
