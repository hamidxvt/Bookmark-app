...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2024boximpl(m2018markNowz9LOYto());
    }
    ...
    public long m2018markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2027constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2017elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2016differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2015adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2027constructorimpl(LongSaturatedMathKt.m2013saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
