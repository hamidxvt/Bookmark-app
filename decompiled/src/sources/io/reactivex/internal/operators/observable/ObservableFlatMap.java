...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        /* JADX WARN: Type inference failed for: r6v0, types: [io.reactivex.ObservableSource<? extends U>] */
        ...
        void subscribeInner(ObservableSource<? extends U> observableSource) {
            while (observableSource instanceof Callable) {
                if (tryEmitScalar(observableSource) && this.maxConcurrency != Integer.MAX_VALUE) {
                    boolean z = false;
                    synchronized (this) {
        ...
        boolean addInner(InnerObserver<T, U> inner) {
            ...
            } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.observers, a, innerObserverArr));
            return true;
        }
        ...
        void removeInner(InnerObserver<T, U> inner) {
            ...
            } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.observers, innerObserverArr, b));
        }
                ...
                if (length == 0) {
                    ...
                    if (length <= i3 || innerObserverArr[i3].id != j) {
                        ...
                        while (i5 < length) {
                            ...
                            i5++;
                            z2 = z3;
                            simplePlainQueue2 = simplePlainQueue3;
                        }
                        i3 = i4;
                        this.lastIndex = i4;
                    ...
                    while (i6 < length) {
                        ...
                        InnerObserver<T, U> innerObserver = innerObserverArr[i7];
                        while (!checkTerminate()) {
                    ...
                    this.lastIndex = i7;
                    this.lastId = innerObserverArr[i7].id;
                }
                if (!z) {
                    i = addAndGet(-i);
                    if (i == 0) {
