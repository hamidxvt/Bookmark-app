...
public final class FlowableSwitchMapCompletable<T> extends Completable {
    ...
    protected void subscribeActual(CompletableObserver s) {
        this.source.subscribe((FlowableSubscriber) new SwitchMapCompletableObserver(s, this.mapper, this.delayErrors));
    }
    ...
    static final class SwitchMapCompletableObserver<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, current, o));
                if (current != null) {
                    current.dispose();
                }
                c.subscribe(o);
        ...
        void innerError(SwitchMapInnerObserver sender, Throwable error) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.inner, sender, null) && this.errors.addThrowable(error)) {
                if (this.delayErrors) {
                    if (this.done) {
