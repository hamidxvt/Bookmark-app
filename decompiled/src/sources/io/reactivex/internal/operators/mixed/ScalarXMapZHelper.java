...
final class ScalarXMapZHelper {
    ...
    static <T> boolean tryAsCompletable(Object obj, Function<? super T, ? extends CompletableSource> function, CompletableObserver completableObserver) {
        if (obj instanceof Callable) {
            ...
            try {
                R.anim animVar = (T) ((Callable) obj).call();
                if (animVar != null) {
                    completableSource = (CompletableSource) ObjectHelper.requireNonNull(function.apply(animVar), "The mapper returned a null CompletableSource");
                }
    ...
    static <T, R> boolean tryAsMaybe(Object obj, Function<? super T, ? extends MaybeSource<? extends R>> function, Observer<? super R> observer) {
        if (obj instanceof Callable) {
            ...
            try {
                R.anim animVar = (T) ((Callable) obj).call();
                if (animVar != null) {
                    maybeSource = (MaybeSource) ObjectHelper.requireNonNull(function.apply(animVar), "The mapper returned a null MaybeSource");
                }
                if (maybeSource == null) {
    ...
    static <T, R> boolean tryAsSingle(Object obj, Function<? super T, ? extends SingleSource<? extends R>> function, Observer<? super R> observer) {
        if (obj instanceof Callable) {
            ...
            try {
                R.anim animVar = (T) ((Callable) obj).call();
                if (animVar != null) {
                    singleSource = (SingleSource) ObjectHelper.requireNonNull(function.apply(animVar), "The mapper returned a null SingleSource");
                }
