    ...
    static final class ParallelReduceFullMainSubscriber<T> extends DeferredScalarSubscription<T> {
        ...
        SlotPair<T> addValue(T value) {
            ...
            while (true) {
                ...
                if (curr == null) {
                    curr = new SlotPair<>();
                    if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.current, null, curr)) {
                        continue;
                    }
                }
                ...
                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.current, curr, null);
            }
            if (c == 0) {
                curr.first = value;
            } else {
        ...
        void innerError(Throwable ex) {
            if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.error, null, ex)) {
                cancel();
