...
public final class ComputationScheduler extends Scheduler implements SchedulerMultiWorkerSupport {
    ...
    public void start() {
        ...
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.pool, NONE, update)) {
            update.shutdown();
        }
    }
    ...
    public void shutdown() {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.pool, curr, NONE));
        curr.shutdown();
    }
