...
final class InstantPeriodicTask implements Callable<Void>, Disposable {
    ...
    void setFirst(Future<?> f) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.first, current, f));
    }
    ...
    void setRest(Future<?> f) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.rest, current, f));
    }
}
