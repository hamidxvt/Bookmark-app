...
public class AlternateFormatsCountryCodeSet {
    static Set<Integer> getCountryCodeSet() {
        ...
        countryCodeSet.add(Integer.valueOf(TypedValues.PositionType.TYPE_SIZE_PERCENT));
        countryCodeSet.add(Integer.valueOf(TypedValues.PositionType.TYPE_PERCENT_X));
