    ...
    public static final class Companion {
        ...
        */
        public final MediaType get(String $this$toMediaType) {
            ...
            String type = group.toLowerCase(US);
            ...
            String subtype = group2.toLowerCase(US2);
            ...
            while (s2 < s) {
                ...
                if (!parameter.lookingAt()) {
                    ...
                    String substring = $this$toMediaType.substring(s2);
                    Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
                    throw new IllegalArgumentException(append.append(substring).append("\" for: \"").append($this$toMediaType).append(Typography.quote).toString().toString());
                }
        ...
        public final MediaType m2222deprecated_get(String mediaType) {
        ...
        public final MediaType m2223deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
