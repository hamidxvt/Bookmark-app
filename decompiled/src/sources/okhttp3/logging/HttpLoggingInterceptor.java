...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        String requestStartMessage2 = "--> " + request.method() + ' ' + request.url() + (connection2 != null ? StringUtils.SPACE + connection2.protocol() : "");
        ...
        try {
            ...
            logger.log(append.append(str4).append(c).append(response.request().url()).append(" (").append(tookMs).append("ms").append(!logHeaders ? ", " + bodySize + " body" : str2).append(')').toString());
            if (logHeaders) {
