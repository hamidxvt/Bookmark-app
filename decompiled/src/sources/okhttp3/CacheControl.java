    ...
    public static final class Companion {
        ...
        */
        public final CacheControl parse(Headers headers) {
            ...
            while (i < size) {
                int i2 = size;
                String directive = headers2.name(i);
                boolean noTransform2 = noTransform;
                String value = headers2.value(i);
                boolean onlyIfCached2 = onlyIfCached;
                if (StringsKt.equals(directive, HttpHeaders.CACHE_CONTROL, true)) {
                    if (headerValue != null) {
                        canUseHeaderValue = false;
                    } else {
                        headerValue = value;
                    }
                } else if (!StringsKt.equals(directive, HttpHeaders.PRAGMA, true)) {
                ...
                while (pos < value.length()) {
                    ...
                    String directive2 = StringsKt.trim((CharSequence) substring).toString();
                    ...
                    if (pos2 != maxAgeSeconds3) {
                        ...
                        if (value.charAt(pos2) != ',' && value.charAt(pos2) != ';') {
                            ...
                            if (pos3 < value.length() && value.charAt(pos3) == '\"') {
                                ...
                                String substring2 = value.substring(pos4, pos5);
                                Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String…ing(startIndex, endIndex)");
                                parameter = substring2;
                                pos = pos5 + 1;
                            } else {
                                pos = indexOfElement(value, ",;", pos3);
                                String substring3 = value.substring(pos3, pos);
                                Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String…ing(startIndex, endIndex)");
                                parameter = StringsKt.trim((CharSequence) substring3).toString();
                            }
                            if (!StringsKt.equals("no-cache", directive2, true)) {
                                noCache = true;
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("no-store", directive2, true)) {
                                noStore = true;
                                directive = name;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("max-age", directive2, true)) {
                                maxAgeSeconds = Util.toNonNegativeInt(parameter, -1);
                                directive = name;
                                noStore = noStore2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("s-maxage", directive2, true)) {
                                int nonNegativeInt = Util.toNonNegativeInt(parameter, -1);
                                directive = name;
                                noStore = noStore2;
                                sMaxAgeSeconds2 = nonNegativeInt;
                                maxAgeSeconds = maxAgeSeconds2;
                            } else if (StringsKt.equals("private", directive2, true)) {
                                isPrivate = true;
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("public", directive2, true)) {
                                isPublic = true;
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("must-revalidate", directive2, true)) {
                                mustRevalidate = true;
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("max-stale", directive2, true)) {
                                maxStaleSeconds = Util.toNonNegativeInt(parameter, Integer.MAX_VALUE);
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("min-fresh", directive2, true)) {
                                minFreshSeconds = Util.toNonNegativeInt(parameter, -1);
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("only-if-cached", directive2, true)) {
                                onlyIfCached2 = true;
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("no-transform", directive2, true)) {
                                noTransform2 = true;
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
                                sMaxAgeSeconds2 = sMaxAgeSeconds;
                            } else if (StringsKt.equals("immutable", directive2, true)) {
                                immutable = true;
                                directive = name;
                                noStore = noStore2;
                                maxAgeSeconds = maxAgeSeconds2;
            ...
            return new CacheControl(noCache, noStore, maxAgeSeconds, sMaxAgeSeconds2, isPrivate, isPublic, mustRevalidate, maxStaleSeconds, minFreshSeconds, onlyIfCached3, noTransform3, immutable, headerValue, null);
        }
