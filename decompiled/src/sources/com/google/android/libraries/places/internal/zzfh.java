...
final class zzfh extends zzfn {
    ...
    /* synthetic */ zzfh(int i, String str, zzhs zzhsVar, Place place, AutocompletePrediction autocompletePrediction, Status status, zzfg zzfgVar) {
        this.zzf = i;
        this.zza = str;
        this.zzb = zzhsVar;
        this.zzc = place;
