...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        if (storedState.additionalHorizontalOffset == null) {
            ...
            intValue15 = storedState.additionalHorizontalOffset.intValue();
        }
        state21.additionalHorizontalOffset = Integer.valueOf(intValue15);
        State state22 = this.currentState;
        if (storedState.additionalVerticalOffset == null) {
            intValue16 = 0;
        } else {
            intValue16 = storedState.additionalVerticalOffset.intValue();
        }
        state22.additionalVerticalOffset = Integer.valueOf(intValue16);
        ...
        state23.autoAdjustToWithinGrandparentBounds = Boolean.valueOf(booleanValue);
        a.recycle();
