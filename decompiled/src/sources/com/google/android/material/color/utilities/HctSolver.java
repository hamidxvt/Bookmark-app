...
public class HctSolver {
    ...
    static int findResultByJ(double hueRadians, double chroma, double y) {
        ...
        while (iterationRound < 5) {
            ...
            double alpha = (chroma == Utils.DOUBLE_EPSILON || j == Utils.DOUBLE_EPSILON) ? 0.0d : chroma / Math.sqrt(jNormalized);
            ...
            if (linrgb[0] < Utils.DOUBLE_EPSILON || linrgb[1] < Utils.DOUBLE_EPSILON || linrgb[2] < Utils.DOUBLE_EPSILON) {
                return 0;
            }
            double kR = Y_FROM_LINRGB[0];
            double kG = Y_FROM_LINRGB[1];
