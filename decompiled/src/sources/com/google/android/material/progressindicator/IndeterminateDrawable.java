...
public final class IndeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    public void draw(Canvas canvas) {
        ...
        boolean drawFullTrack = drawTrack && gapSize == 0 && !this.baseSpec.hasWavyEffect(false);
        if (drawFullTrack) {
            ...
            if (this.drawingDelegate instanceof LinearDrawingDelegate) {
                ...
                this.drawingDelegate.fillTrack(canvas, this.paint, lastIndicator.endFraction, 1.0f + firstIndicator.startFraction, this.baseSpec.trackColor, trackAlpha, gapSize);
                canvas.restore();
            }
        }
