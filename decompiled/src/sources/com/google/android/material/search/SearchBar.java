...
public class SearchBar extends Toolbar {
    ...
    private void layoutTextViewCenterAvoidToolbarViewsAndPadding() {
        int textViewContainerLeft = (getMeasuredWidth() / 2) - (this.textViewContainer.getMeasuredWidth() / 2);
        int textViewContainerRight = this.textViewContainer.getMeasuredWidth() + textViewContainerLeft;
        ...
        this.textViewContainer.layout(textViewContainerLeft + totalShift, textViewContainerTop, textViewContainerRight + totalShift, textViewContainerBottom);
    }
