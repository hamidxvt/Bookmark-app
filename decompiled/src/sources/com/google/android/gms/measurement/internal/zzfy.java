...
public final class zzfy {
    ...
    static {
        ...
        zzc = zza("measurement.monitoring.sample_period_millis", valueOf3, valueOf3, zzcf.zza, false);
        zzd = zza("measurement.config.cache_time", valueOf3, valueOf2, zzcq.zza, false);
        ...
        zzB = zza("measurement.sgtm.upload.min_delay_after_startup", valueOf4, valueOf4, zzcm.zza, false);
        ...
        zzL = zza("measurement.alarm_manager.minimum_interval", valueOf5, valueOf5, zzcx.zza, false);
        zzM = zza("measurement.upload.stale_data_deletion_interval", valueOf3, valueOf3, zzcy.zza, false);
        ...
        Long valueOf6 = Long.valueOf(PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS);
        zzS = zza("measurement.upload.google_signal_max_queue_time", valueOf6, valueOf6, zzdf.zza, false);
        ...
        zzY = zza("measurement.service_client.idle_disconnect_millis", valueOf4, valueOf4, zzdi.zza, false);
        ...
        zzae = zza("measurement.test.double_flag", valueOf7, valueOf7, zzdq.zza, false);
