...
public class GoogleMap {
    ...
    public final GroundOverlay addGroundOverlay(GroundOverlayOptions options) {
        try {
            ...
            com.google.android.gms.internal.maps.zzx addGroundOverlay = this.zza.addGroundOverlay(options);
    ...
    public final Marker addMarker(MarkerOptions options) {
        ...
        try {
            ...
            com.google.android.gms.internal.maps.zzaj addMarker = this.zza.addMarker(options);
            if (addMarker != null) {
                return options.zzb() == 1 ? new AdvancedMarker(addMarker) : new Marker(addMarker);
            }
            return null;
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
    ...
    public final TileOverlay addTileOverlay(TileOverlayOptions options) {
        try {
            ...
            com.google.android.gms.internal.maps.zzaw addTileOverlay = this.zza.addTileOverlay(options);
    ...
    public final void removeOnMapCapabilitiesChangedListener(OnMapCapabilitiesChangedListener listener) {
        try {
            ...
            if (map.containsKey(listener)) {
                this.zza.removeOnMapCapabilitiesChangedListener((com.google.android.gms.maps.internal.zzal) map.get(listener));
                map.remove(listener);
            }
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
