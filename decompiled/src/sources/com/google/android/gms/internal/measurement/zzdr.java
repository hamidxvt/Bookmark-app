...
final class zzdr extends zzeq {
    ...
    public final void zza() {
        try {
            ...
            zzfbVar.zzR(zzfbVar.zzc(context, zzc != null ? !zzc.booleanValue() : true));
            if (zzfbVar.zzQ() == null) {
            ...
            ((zzcr) Preconditions.checkNotNull(zzfbVar.zzQ())).initialize(ObjectWrapper.wrap(context), new zzdd(133005L, Math.max(localVersion, r0), !Boolean.TRUE.equals(zzc) ? DynamiteModule.getRemoteVersion(context, ModuleDescriptor.MODULE_ID) < localVersion : true, this.zzb, com.google.android.gms.measurement.internal.zzhu.zza(context)), this.zzh);
        } catch (Exception e) {
