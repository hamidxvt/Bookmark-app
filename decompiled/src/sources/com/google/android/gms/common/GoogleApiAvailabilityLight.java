...
public class GoogleApiAvailabilityLight {
        ...
        switch (errorCode) {
            ...
            case 2:
                if (context != null && DeviceProperties.isWearableWithoutPlayStore(context)) {
                    int i = com.google.android.gms.common.internal.zzu.zza;
                ...
                Uri.Builder appendQueryParameter = Uri.parse("market://details").buildUpon().appendQueryParameter(Constant.VISIT_ID, "com.google.android.gms");
    ...
    public PendingIntent getErrorResolutionPendingIntent(Context context, int errorCode, int requestCode, String trackingSource) {
        ...
        return PendingIntentCompat.getActivity(context, requestCode, errorResolutionIntent, 134217728, false);
    }
