...
public abstract class FastJsonResponse {
    ...
    protected Object getFieldValue(Field field) {
        ...
        boolean z = field.zad;
        try {
            return getClass().getMethod(Constant.RetrofitConstants.RETROFIT_METHOD_GET + Character.toUpperCase(str.charAt(0)) + str.substring(1), new Class[0]).invoke(this, new Object[0]);
        } catch (Exception e) {
