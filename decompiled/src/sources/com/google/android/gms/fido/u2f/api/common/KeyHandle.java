...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    public static KeyHandle parseFromJson(JSONObject registeredKey) throws JSONException {
        try {
            try {
                return new KeyHandle(Base64.decode(registeredKey.getString(SignResponseData.JSON_RESPONSE_DATA_KEY_HANDLE), 8), ProtocolVersion.fromString(registeredKey.has("version") ? registeredKey.getString("version") : null), registeredKey.has("transports") ? Transport.parseTransports(registeredKey.getJSONArray("transports")) : null);
