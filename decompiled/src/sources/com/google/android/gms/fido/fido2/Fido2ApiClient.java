...
public class Fido2ApiClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    private static final Api zzb = new Api("Fido.FIDO2_API", new com.google.android.gms.internal.fido.zzo(), zza);
    ...
    @Deprecated
    public Task<Fido2PendingIntent> getRegisterIntent(final PublicKeyCredentialCreationOptions requestOptions) {
    ...
    public Task<PendingIntent> getRegisterPendingIntent(final PublicKeyCredentialCreationOptions requestOptions) {
    ...
    @Deprecated
    public Task<Fido2PendingIntent> getSignIntent(final PublicKeyCredentialRequestOptions requestOptions) {
    ...
    public Task<PendingIntent> getSignPendingIntent(final PublicKeyCredentialRequestOptions requestOptions) {
