...
public class U2fApiClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    public Task<U2fPendingIntent> getRegisterIntent(final RegisterRequestParams requestParams) {
