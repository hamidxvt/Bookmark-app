...
public class RegisteredKey extends AbstractSafeParcelable {
    ...
    public static RegisteredKey parseFromJson(JSONObject signRequest) throws JSONException {
        return new RegisteredKey(KeyHandle.parseFromJson(signRequest), signRequest.has(ClientData.KEY_CHALLENGE) ? signRequest.getString(ClientData.KEY_CHALLENGE) : null, signRequest.has("appId") ? signRequest.getString("appId") : null);
    }
