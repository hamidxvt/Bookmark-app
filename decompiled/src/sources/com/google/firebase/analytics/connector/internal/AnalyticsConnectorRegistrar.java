...
public class AnalyticsConnectorRegistrar implements ComponentRegistrar {
    ...
    public static /* synthetic */ AnalyticsConnector lambda$getComponents$0(ComponentContainer container) {
        return AnalyticsConnectorImpl.getInstance((FirebaseApp) container.get(FirebaseApp.class), (Context) container.get(Context.class), (Subscriber) container.get(Subscriber.class));
    }
