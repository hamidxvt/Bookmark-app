...
public class TransportRegistrar implements ComponentRegistrar {
    ...
    static /* synthetic */ TransportFactory lambda$getComponents$1(ComponentContainer c) {
        TransportRuntime.initialize((Context) c.get(Context.class));
        return TransportRuntime.getInstance().newFactory(CCTDestination.LEGACY_INSTANCE);
    }

    static /* synthetic */ TransportFactory lambda$getComponents$2(ComponentContainer c) {
        TransportRuntime.initialize((Context) c.get(Context.class));
