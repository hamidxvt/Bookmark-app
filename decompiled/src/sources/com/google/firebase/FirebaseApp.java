...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context applicationContext, String name, FirebaseOptions options) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return FirebaseApp.this.m357lambda$new$0$comgooglefirebaseFirebaseApp(applicationContext);
            }
        });
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda1
            ...
            public final void onBackgroundStateChanged(boolean z) {
                FirebaseApp.this.m358lambda$new$1$comgooglefirebaseFirebaseApp(z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    /* synthetic */ DataCollectionConfigStorage m357lambda$new$0$comgooglefirebaseFirebaseApp(Context applicationContext) {
    ...
    /* synthetic */ void m358lambda$new$1$comgooglefirebaseFirebaseApp(boolean background) {
        if (!background) {
    ...
    public static String getPersistenceKey(String name, FirebaseOptions options) {
        return Base64Utils.encodeUrlSafeNoPadding(name.getBytes(Charset.defaultCharset())) + Marker.ANY_NON_NULL_MARKER + Base64Utils.encodeUrlSafeNoPadding(options.getApplicationId().getBytes(Charset.defaultCharset()));
    }
