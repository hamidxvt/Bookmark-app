...
public final class CacheStats {
    ...
    public double missRate() {
        long requestCount = requestCount();
        return requestCount == 0 ? Utils.DOUBLE_EPSILON : this.missCount / requestCount;
    }
    ...
    public double loadExceptionRate() {
        ...
        return totalLoadCount == 0 ? Utils.DOUBLE_EPSILON : this.loadExceptionCount / totalLoadCount;
    }
    ...
    public double averageLoadPenalty() {
        long totalLoadCount = LongMath.saturatedAdd(this.loadSuccessCount, this.loadExceptionCount);
        return totalLoadCount == 0 ? Utils.DOUBLE_EPSILON : this.totalLoadTime / totalLoadCount;
    }
