...
public final class CodeScanner {
    ...
    private final class PreviewCallback implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            DecoderWrapper decoderWrapper;
            Rect frameRect;
            if (!CodeScanner.this.mInitialized || CodeScanner.this.mStoppingPreview || CodeScanner.this.mScanMode == ScanMode.PREVIEW || data == null || (decoderWrapper = CodeScanner.this.mDecoderWrapper) == null) {
                return;
            }
        ...
        private void initialize() {
            ...
            if (parameters != null) {
                ...
                synchronized (CodeScanner.this.mInitializeLock) {
                    try {
                        try {
                            Decoder decoder = new Decoder(CodeScanner.this.mDecoderStateListener, CodeScanner.this.mExceptionHandler, CodeScanner.this.mFormats, CodeScanner.this.mDecodeCallback);
                            try {
                                CodeScanner.this.mDecoderWrapper = new DecoderWrapper(camera, cameraInfo, decoder, imageSize, previewSize, viewSize, orientation, autoFocusSupported, flashSupported);
                                decoder.start();
