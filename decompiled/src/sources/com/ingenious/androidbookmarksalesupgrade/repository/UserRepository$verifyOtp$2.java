...
@DebugMetadata(c = "com.ingenious.androidbookmarksalesupgrade.repository.UserRepository$verifyOtp$2", f = "UserRepository.kt", i = {}, l = {38}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes15.dex */
final class UserRepository$verifyOtp$2 extends SuspendLambda implements Function1<Continuation<? super ApiResponseCallback<GlobalResponse>>, Object> {
    final /* synthetic */ VerifyOtpRequest $verifyOtpRequest;
    int label;
    final /* synthetic */ UserRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    UserRepository$verifyOtp$2(UserRepository userRepository, VerifyOtpRequest verifyOtpRequest, Continuation<? super UserRepository$verifyOtp$2> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new UserRepository$verifyOtp$2(this.this$0, this.$verifyOtpRequest, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super ApiResponseCallback<GlobalResponse>> continuation) {
        return ((UserRepository$verifyOtp$2) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                Object verifyOtp = dataSource.verifyOtp(this.$verifyOtpRequest, this);
