...
@DebugMetadata(c = "com.ingenious.androidbookmarksalesupgrade.repository.UserRepository$forgetPassword$2", f = "UserRepository.kt", i = {}, l = {32}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes15.dex */
final class UserRepository$forgetPassword$2 extends SuspendLambda implements Function1<Continuation<? super ApiResponseCallback<GlobalResponse>>, Object> {
    final /* synthetic */ ForgetRequest $forgetRequest;
    int label;
    final /* synthetic */ UserRepository this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    UserRepository$forgetPassword$2(UserRepository userRepository, ForgetRequest forgetRequest, Continuation<? super UserRepository$forgetPassword$2> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new UserRepository$forgetPassword$2(this.this$0, this.$forgetRequest, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super ApiResponseCallback<GlobalResponse>> continuation) {
        return ((UserRepository$forgetPassword$2) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                Object forgetPassword = dataSource.forgetPassword(this.$forgetRequest, this);
