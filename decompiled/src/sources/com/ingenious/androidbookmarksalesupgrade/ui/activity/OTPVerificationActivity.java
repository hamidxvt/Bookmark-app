...
import com.ingenious.androidbookmarksalesupgrade.databinding.ActivityOtpverificationBinding;
...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0012\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u0011H\u0014R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082.¢\u0006\u0002\n\u0000R\u001b\u0010\u0006\u001a\u00020\u00078BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\b\u0010\tR\u000e\u0010\f\u001a\u00020\rX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"Lcom/ingenious/androidbookmarksalesupgrade/ui/activity/OTPVerificationActivity;", "Lcom/ingenious/androidbookmarksalesupgrade/ui/activity/BaseActivity;", "<init>", "()V", "binding", "Lcom/ingenious/androidbookmarksalesupgrade/databinding/ActivityOtpverificationBinding;", "viewModel", "Lcom/ingenious/androidbookmarksalesupgrade/viewModel/UserViewModel;", "getViewModel", "()Lcom/ingenious/androidbookmarksalesupgrade/viewModel/UserViewModel;", "viewModel$delegate", "Lkotlin/Lazy;", "email", "", "onCreate", "", "savedInstanceState", "Landroid/os/Bundle;", "app_debug"}, k = 1, mv = {2, 1, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class OTPVerificationActivity extends BaseActivity {
    ...
    public OTPVerificationActivity() {
        final OTPVerificationActivity $this$viewModel_u24default$iv = this;
        final Qualifier qualifier$iv = null;
        final Function0 owner$iv = new Function0<ViewModelOwner>() { // from class: com.ingenious.androidbookmarksalesupgrade.ui.activity.OTPVerificationActivity$special$$inlined$viewModel$default$1
            {
                super(0);
            }
        ...
        Function0 factoryProducer$iv$iv = new Function0<ViewModelProvider.Factory>() { // from class: com.ingenious.androidbookmarksalesupgrade.ui.activity.OTPVerificationActivity$special$$inlined$viewModel$default$2
        ...
        this.viewModel = new ViewModelLazy(Reflection.getOrCreateKotlinClass(UserViewModel.class), new Function0<ViewModelStore>() { // from class: com.ingenious.androidbookmarksalesupgrade.ui.activity.OTPVerificationActivity$special$$inlined$viewModel$default$3
            {
                super(0);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.binding = ActivityOtpverificationBinding.inflate(getLayoutInflater());
        ...
        getViewModel().getVerifyOtpResponse().observe(this, new Observer() { // from class: com.ingenious.androidbookmarksalesupgrade.ui.activity.OTPVerificationActivity$$ExternalSyntheticLambda0
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                OTPVerificationActivity.onCreate$lambda$3(OTPVerificationActivity.this, (ApiResponseCallback) obj);
            }
        });
        ...
        activityOtpverificationBinding2.setListener(new GenericListeners() { // from class: com.ingenious.androidbookmarksalesupgrade.ui.activity.OTPVerificationActivity$onCreate$2
            ...
            public void onTapOTP() {
                ...
                viewModel.verifyOtpRequest(new VerifyOtpRequest(String.valueOf(activityOtpverificationBinding4.etOtp.getText())));
            }
        });
    }
    ...
    public static final void onCreate$lambda$3(final OTPVerificationActivity this$0, ApiResponseCallback it) {
        if (it != null) {
            ...
            if (it instanceof ApiResponseCallback.Error) {
                ...
                LayoutLoadingBinding layoutProgressIndicator = activityOtpverificationBinding.layoutProgressIndicator;
                ...
                this$0.genericNetworkErrorHandler(it, new Function1() { // from class: com.ingenious.androidbookmarksalesupgrade.ui.activity.OTPVerificationActivity$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        Unit onCreate$lambda$3$lambda$2$lambda$0;
                        onCreate$lambda$3$lambda$2$lambda$0 = OTPVerificationActivity.onCreate$lambda$3$lambda$2$lambda$0((ErrorHandler) obj);
            ...
            if (it instanceof ApiResponseCallback.Loading) {
                ...
                LayoutLoadingBinding layoutProgressIndicator2 = activityOtpverificationBinding.layoutProgressIndicator;
            ...
            ActivityOtpverificationBinding activityOtpverificationBinding4 = this$0.binding;
            if (activityOtpverificationBinding4 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("binding");
                activityOtpverificationBinding4 = null;
            }
            LayoutLoadingBinding layoutProgressIndicator3 = activityOtpverificationBinding4.layoutProgressIndicator;
            ...
            if (data != null) {
                ...
                if (success.booleanValue()) {
                    ...
                    ActivityExtKt.showMaterialAlertDialog(this$0, message, new DialogListeners() { // from class: com.ingenious.androidbookmarksalesupgrade.ui.activity.OTPVerificationActivity$onCreate$1$1$2$1
                        ...
                        public void onPositionButtonTap(DialogInterface dialog) {
                            ...
                            str = OTPVerificationActivity.this.email;
                            ActivityExtKt.gotoActivity(oTPVerificationActivity, ResetPasswordActivity.class, "email", str);
