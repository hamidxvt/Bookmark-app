...
@DebugMetadata(c = "com.ingenious.androidbookmarksalesupgrade.network.domain.DataSource$resetPassword$2", f = "DataSource.kt", i = {}, l = {43}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes15.dex */
final class DataSource$resetPassword$2 extends SuspendLambda implements Function1<Continuation<? super Response<GlobalResponse>>, Object> {
    final /* synthetic */ ResetPasswordRequest $resetPasswordRequest;
    int label;
    final /* synthetic */ DataSource this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DataSource$resetPassword$2(DataSource dataSource, ResetPasswordRequest resetPasswordRequest, Continuation<? super DataSource$resetPassword$2> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new DataSource$resetPassword$2(this.this$0, this.$resetPasswordRequest, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super Response<GlobalResponse>> continuation) {
        return ((DataSource$resetPassword$2) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                Object resetPassword = soService.resetPassword(this.$resetPasswordRequest, this);
