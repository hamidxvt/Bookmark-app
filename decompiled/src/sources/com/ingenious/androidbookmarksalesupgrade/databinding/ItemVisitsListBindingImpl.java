...
public class ItemVisitsListBindingImpl extends ItemVisitsListBinding {
    ...
    public ItemVisitsListBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private ItemVisitsListBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        if (2 == variableId) {
            setItem((TodayVisitsList) variable);
            return true;
        }
        if (3 == variableId) {
    ...
    @Override // com.ingenious.androidbookmarksalesupgrade.databinding.ItemVisitsListBinding
    public void setItem(TodayVisitsList Item) {
        this.mItem = Item;
        synchronized (this) {
            this.mDirtyFlags |= 1;
        }
    ...
    protected void executeBindings() {
        ...
        TodayVisitsList item = this.mItem;
