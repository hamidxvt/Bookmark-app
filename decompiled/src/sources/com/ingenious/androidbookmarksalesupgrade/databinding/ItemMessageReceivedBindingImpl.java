...
public class ItemMessageReceivedBindingImpl extends ItemMessageReceivedBinding {
    ...
    public ItemMessageReceivedBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private ItemMessageReceivedBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.ingenious.androidbookmarksalesupgrade.databinding.ItemMessageReceivedBinding
