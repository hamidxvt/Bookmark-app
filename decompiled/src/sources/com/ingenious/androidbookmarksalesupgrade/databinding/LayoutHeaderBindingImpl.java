...
public class LayoutHeaderBindingImpl extends LayoutHeaderBinding implements OnClickListener.Listener {
    ...
    public LayoutHeaderBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private LayoutHeaderBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.ingenious.androidbookmarksalesupgrade.databinding.LayoutHeaderBinding
