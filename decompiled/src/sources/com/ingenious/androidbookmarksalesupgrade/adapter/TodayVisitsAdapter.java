...
import com.ingenious.androidbookmarksalesupgrade.databinding.ItemVisitsListBinding;
...
/* compiled from: TodayVisitsAdapter.kt */
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\f\u0012\b\u0012\u00060\u0002R\u00020\u00000\u0001:\u0001\u001cB-\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u000e\b\u0002\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\t¢\u0006\u0004\b\n\u0010\u000bJ\u001c\u0010\u0010\u001a\u00060\u0002R\u00020\u00002\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J\u001c\u0010\u0015\u001a\u00020\u00162\n\u0010\u0017\u001a\u00060\u0002R\u00020\u00002\u0006\u0010\u0018\u001a\u00020\u0014H\u0016J\b\u0010\u0019\u001a\u00020\u0014H\u0016J\u0014\u0010\u001a\u001a\u00020\u00162\f\u0010\u001b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u000e\u001a\u0004\u0018\u00010\u000fX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001d"}, d2 = {"Lcom/ingenious/androidbookmarksalesupgrade/adapter/TodayVisitsAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lcom/ingenious/androidbookmarksalesupgrade/adapter/TodayVisitsAdapter$ViewHolder;", "context", "Landroid/content/Context;", FirebaseAnalytics.Param.ITEMS, "", "Lcom/ingenious/androidbookmarksalesupgrade/model/response/TodayVisitsList;", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "Lcom/ingenious/androidbookmarksalesupgrade/adapter/GenericAdapter$OnItemClickListener;", "<init>", "(Landroid/content/Context;Ljava/util/List;Lcom/ingenious/androidbookmarksalesupgrade/adapter/GenericAdapter$OnItemClickListener;)V", "getContext", "()Landroid/content/Context;", "viewModel", "Lcom/ingenious/androidbookmarksalesupgrade/viewModel/VisitViewModel;", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "", "onBindViewHolder", "", "holder", "position", "getItemCount", "addList", "newItems", "ViewHolder", "app_debug"}, k = 1, mv = {2, 1, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
/* loaded from: classes7.dex */
public final class TodayVisitsAdapter extends RecyclerView.Adapter<ViewHolder> {
    private final Context context;
    private List<TodayVisitsList> items;
    private final GenericAdapter.OnItemClickListener<TodayVisitsList> listener;
    private final VisitViewModel viewModel;

    public /* synthetic */ TodayVisitsAdapter(Context context, List list, GenericAdapter.OnItemClickListener onItemClickListener, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public TodayVisitsAdapter(Context context, List<TodayVisitsList> items, GenericAdapter.OnItemClickListener<TodayVisitsList> listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemVisitsListBinding binding = ItemVisitsListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public final void addList(List<TodayVisitsList> newItems) {
    ...
    /* compiled from: TodayVisitsAdapter.kt */
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0004\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0006\u0010\b\u001a\u00020\tJ\u000e\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\fR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\r"}, d2 = {"Lcom/ingenious/androidbookmarksalesupgrade/adapter/TodayVisitsAdapter$ViewHolder;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "binding", "Lcom/ingenious/androidbookmarksalesupgrade/databinding/ItemVisitsListBinding;", "<init>", "(Lcom/ingenious/androidbookmarksalesupgrade/adapter/TodayVisitsAdapter;Lcom/ingenious/androidbookmarksalesupgrade/databinding/ItemVisitsListBinding;)V", "timer", "Landroid/os/CountDownTimer;", "clearTimer", "", "bind", "item", "Lcom/ingenious/androidbookmarksalesupgrade/model/response/TodayVisitsList;", "app_debug"}, k = 1, mv = {2, 1, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public final class ViewHolder extends RecyclerView.ViewHolder {
        private final ItemVisitsListBinding binding;
        final /* synthetic */ TodayVisitsAdapter this$0;
        private CountDownTimer timer;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ViewHolder(TodayVisitsAdapter this$0, ItemVisitsListBinding binding) {
        ...
        public final void bind(final TodayVisitsList item) {
            String str;
            String str2;
            ...
            if (Intrinsics.areEqual(str, "schools")) {
                ...
                this.binding.customerType.setTextColor(ContextCompat.getColor(this.this$0.getContext(), R.color.tag_text_color1));
                ...
                switch (str2.hashCode()) {
                    ...
                    case 3202466:
                        if (str2.equals("high")) {
                            ...
                            this.binding.priority.setTextColor(ContextCompat.getColor(this.this$0.getContext(), R.color.tag_text_color3));
            ...
            if (Intrinsics.areEqual(item.getStatus(), "on-going")) {
                ...
                if (!(visitDate == null || visitDate.length() == 0)) {
                    ...
                    if (!(visitStartTime == null || visitStartTime.length() == 0)) {
                        ...
                        this.timer = new CountDownTimer() { // from class: com.ingenious.androidbookmarksalesupgrade.adapter.TodayVisitsAdapter$ViewHolder$bind$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                            ...
                            public void onTick(long millisUntilFinished) {
                                ItemVisitsListBinding itemVisitsListBinding;
                                ...
                                itemVisitsListBinding = this.binding;
                                Button button = itemVisitsListBinding.btnCheckIn;
            ...
            final TodayVisitsAdapter todayVisitsAdapter = this.this$0;
            button.setOnClickListener(new View.OnClickListener() { // from class: com.ingenious.androidbookmarksalesupgrade.adapter.TodayVisitsAdapter$ViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    TodayVisitsAdapter.ViewHolder.bind$lambda$0(TodayVisitsAdapter.this, item, view);
                }
            });
            View root = this.binding.getRoot();
            final TodayVisitsAdapter todayVisitsAdapter2 = this.this$0;
            root.setOnClickListener(new View.OnClickListener() { // from class: com.ingenious.androidbookmarksalesupgrade.adapter.TodayVisitsAdapter$ViewHolder$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    TodayVisitsAdapter.ViewHolder.bind$lambda$1(TodayVisitsAdapter.this, item, view);
                }
            });
            this.binding.executePendingBindings();
            ImageButton imageButton = this.binding.btnCall;
            final TodayVisitsAdapter todayVisitsAdapter3 = this.this$0;
            imageButton.setOnClickListener(new View.OnClickListener() { // from class: com.ingenious.androidbookmarksalesupgrade.adapter.TodayVisitsAdapter$ViewHolder$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    TodayVisitsAdapter.ViewHolder.bind$lambda$2(TodayVisitsAdapter.this, item, view);
                }
            });
            ImageButton imageButton2 = this.binding.btnNavigate;
            final TodayVisitsAdapter todayVisitsAdapter4 = this.this$0;
            imageButton2.setOnClickListener(new View.OnClickListener() { // from class: com.ingenious.androidbookmarksalesupgrade.adapter.TodayVisitsAdapter$ViewHolder$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    TodayVisitsAdapter.ViewHolder.bind$lambda$3(TodayVisitsList.this, todayVisitsAdapter4, view);
                }
            });
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void bind$lambda$0(TodayVisitsAdapter this$0, TodayVisitsList $item, View it) {
            this$0.listener.onItemClickTwo($item);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void bind$lambda$1(TodayVisitsAdapter this$0, TodayVisitsList $item, View it) {
            this$0.listener.onItemClick($item);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void bind$lambda$2(TodayVisitsAdapter this$0, TodayVisitsList $item, View it) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final void bind$lambda$3(TodayVisitsList $item, TodayVisitsAdapter this$0, View it) {
