...
public final /* data */ class SubjectsListResponse extends GlobalResponse {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ SubjectsListResponse copy$default(SubjectsListResponse subjectsListResponse, ArrayList arrayList, int i, Object obj) {
        if ((i & 1) != 0) {
            arrayList = subjectsListResponse.data;
        }
        return subjectsListResponse.copy(arrayList);
    }
    ...
    public final SubjectsListResponse copy(ArrayList<GradesSubjectsData> data) {
        Intrinsics.checkNotNullParameter(data, "data");
        return new SubjectsListResponse(data);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SubjectsListResponse) && Intrinsics.areEqual(this.data, ((SubjectsListResponse) other).data);
    }
    ...
    public String toString() {
        return "SubjectsListResponse(data=" + this.data + ")";
    }

    public /* synthetic */ SubjectsListResponse(ArrayList arrayList, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public SubjectsListResponse(ArrayList<GradesSubjectsData> data) {
