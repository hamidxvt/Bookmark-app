...
final class JsonUtf8Reader extends JsonReader {
    ...
    private int peekKeyword() throws IOException {
        ...
        if (c == 116 || c == 84) {
            keyword = BooleanUtils.TRUE;
            keywordUpper = "TRUE";
            peeking = 5;
        } else if (c == 102 || c == 70) {
            keyword = BooleanUtils.FALSE;
            keywordUpper = "FALSE";
            peeking = 6;
        } else {
            if (c != 110 && c != 78) {
    ...
    */
    ...
    private boolean skipToEndOfBlockComment() throws IOException {
        ...
        this.buffer.skip(found ? CLOSING_BLOCK_COMMENT.size() + index : this.buffer.size());
        return found;
    }
