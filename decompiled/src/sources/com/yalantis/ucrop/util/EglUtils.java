...
public class EglUtils {
    ...
    private static int getMaxTextureEgl14() {
        ...
        int[] configAttr = {12351, 12430, 12329, 0, 12352, 4, 12339, 1, 12344};
        ...
        int[] surfAttr = {12375, 64, 12374, 64, 12344};
        EGLSurface surf = EGL14.eglCreatePbufferSurface(dpy, config, surfAttr, 0);
        int[] ctxAttrib = {12440, 2, 12344};
    ...
    private static int getMaxTextureEgl10() {
        ...
        int[] configAttr = {12351, 12430, 12329, 0, 12339, 1, 12344};
