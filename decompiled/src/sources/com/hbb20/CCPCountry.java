...
public class CCPCountry implements Comparable<CCPCountry> {
    ...
    static CCPCountry getCountryForCodeFromEnglishList(String code) {
        List<CCPCountry> countries = getLibraryMasterCountriesEnglish();
    ...
    public static CCPCountry getCountryForNameCodeFromLibraryMasterList(Context context, CountryCodePicker.Language language, String nameCode) {
        List<CCPCountry> countries = getLibraryMasterCountryList(context, language);
        for (CCPCountry ccpCountry : countries) {
            if (ccpCountry.getNameCode().equalsIgnoreCase(nameCode)) {
                return ccpCountry;
            }
            ...
            for (int i = firstDigit; i <= fullNumber2.length(); i++) {
                ...
                if (countryGroup != null) {
                    ...
                    if (fullNumber2.length() >= countryGroup.areaCodeLength + areaCodeStartsAt) {
                        String areaCode = fullNumber2.substring(areaCodeStartsAt, countryGroup.areaCodeLength + areaCodeStartsAt);
                        return countryGroup.getCountryForAreaCode(context, language, areaCode);
                    }
                    String areaCode2 = countryGroup.defaultNameCode;
                    return getCountryForNameCodeFromLibraryMasterList(context, language, areaCode2);
                }
    ...
    static int getFlagMasterResID(CCPCountry CCPCountry) {
        ...
        switch (lowerCase.hashCode()) {
            ...
            case 3341:
                ...
                break;
            case 3355:
                if (lowerCase.equals(Constant.VISIT_ID)) {
                    c = '_';
                    break;
                }
                c = 65535;
        ...
        switch (c) {
            ...
            case com.github.gcacace.signaturepad.BuildConfig.VERSION_CODE /* 110 */:
    ...
    public static List<CCPCountry> getLibraryMasterCountriesEnglish() {
        ...
        countries.add(new CCPCountry(Constant.VISIT_ID, "62", "Indonesia", DEFAULT_FLAG_RES));
        ...
        countries.add(new CCPCountry(BooleanUtils.NO, "47", "Norway", DEFAULT_FLAG_RES));
        ...
        countries.add(new CCPCountry(TypedValues.TransitionType.S_TO, "676", "Tonga", DEFAULT_FLAG_RES));
