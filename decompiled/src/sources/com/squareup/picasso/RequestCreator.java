...
public class RequestCreator {
    ...
    public void into(RemoteViews remoteViews, int viewId, int notificationId, Notification notification, String notificationTag, Callback callback) {
        ...
        Request request = createRequest(started);
        String key = Utils.createKey(request, new StringBuilder());
        RemoteViewsAction action = new RemoteViewsAction.NotificationAction(this.picasso, request, remoteViews, viewId, notificationId, notification, notificationTag, this.memoryPolicy, this.networkPolicy, key, this.tag, this.errorResId, callback);
    ...
    public void into(RemoteViews remoteViews, int viewId, int[] appWidgetIds, Callback callback) {
        ...
        Request request = createRequest(started);
        String key = Utils.createKey(request, new StringBuilder());
        RemoteViewsAction action = new RemoteViewsAction.AppWidgetAction(this.picasso, request, remoteViews, viewId, appWidgetIds, this.memoryPolicy, this.networkPolicy, key, this.tag, this.errorResId, callback);
        performRemoteViewInto(action);
    }
