...
public class ColorTemplate {
    ...
    public static final int[] LIBERTY_COLORS = {Color.rgb(207, 248, 246), Color.rgb(148, 212, 212), Color.rgb(136, BarcodeUtils.ROTATION_180, 187), Color.rgb(118, 174, 175), Color.rgb(42, AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY, 130)};
