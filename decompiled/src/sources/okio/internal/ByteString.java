...
public final class ByteString {
    ...
    public static final String commonToString(okio.ByteString $this$commonToString) {
        ...
        String safeText = StringsKt.replace$default(StringsKt.replace$default(StringsKt.replace$default(substring, "\\", "\\\\", false, 4, (Object) null), StringUtils.LF, "\\n", false, 4, (Object) null), StringUtils.CR, "\\r", false, 4, (Object) null);
        if (i < text.length()) {
                                ...
                                if ($i$f$isUtf8Continuation == 0) {
                                    ...
                                    if ($i$f$isUtf8Continuation2 == 0) {
                                        ...
                                        if (other$iv$iv$iv$iv7 == 128) {
                                            int codePoint$iv$iv3 = (((3678080 ^ b3$iv$iv) ^ (b2$iv$iv2 << 6)) ^ (b1$iv$iv3 << 12)) ^ (b0$iv$iv3 << Ascii.DC2);
