...
public final class SegmentedByteString {
    ...
    public static final int segment(C0036SegmentedByteString $this$segment, int pos) {
    ...
    public static final void forEachSegment(C0036SegmentedByteString $this$forEachSegment, Function3<? super byte[], ? super Integer, ? super Integer, Unit> action) {
    ...
    private static final void forEachSegment(C0036SegmentedByteString $this$forEachSegment, int beginIndex, int endIndex, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
    ...
    public static final ByteString commonSubstring(C0036SegmentedByteString $this$commonSubstring, int beginIndex, int endIndex) {
        ...
        return new C0036SegmentedByteString(newSegments, newDirectory);
    }

    public static final byte commonInternalGet(C0036SegmentedByteString $this$commonInternalGet, int pos) {
    ...
    public static final int commonGetSize(C0036SegmentedByteString $this$commonGetSize) {
    ...
    public static final byte[] commonToByteArray(C0036SegmentedByteString $this$commonToByteArray) {
    ...
    public static final void commonWrite(C0036SegmentedByteString $this$commonWrite, Buffer buffer, int offset, int byteCount) {
        int $i$f$commonWrite;
    ...
    public static final boolean commonRangeEquals(C0036SegmentedByteString $this$commonRangeEquals, int offset, ByteString other, int otherOffset, int byteCount) {
    ...
    public static final boolean commonRangeEquals(C0036SegmentedByteString $this$commonRangeEquals, int offset, byte[] other, int otherOffset, int byteCount) {
        Intrinsics.checkNotNullParameter($this$commonRangeEquals, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
    ...
    public static final void commonCopyInto(C0036SegmentedByteString $this$commonCopyInto, int offset, byte[] target, int targetOffset, int byteCount) {
    ...
    public static final boolean commonEquals(C0036SegmentedByteString $this$commonEquals, Object other) {
    ...
    public static final int commonHashCode(C0036SegmentedByteString $this$commonHashCode) {
