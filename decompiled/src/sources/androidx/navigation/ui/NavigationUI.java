...
public final class NavigationUI {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x009b, code lost:
        ...
        if (matchDestination$navigation_ui_release(r4, r8.getItemId()) == true) goto L16;
     */
    @JvmStatic
    /*
    ...
    */
    public static final boolean onNavDestinationSelected(MenuItem item, NavController navController) {
        ...
        try {
            ...
            String name = NavDestination.INSTANCE.getDisplayName(navController.getContext(), item.getItemId());
            Log.i(TAG, "Ignoring onNavDestinationSelected for MenuItem " + name + " as it cannot be found from the current destination " + navController.getCurrentDestination(), e);
            return false;
        }
    }
