...
public final class NavGraphViewModelLazyKt {
    ...
    public static final NavBackStackEntry m146navGraphViewModels$lambda0(Lazy<NavBackStackEntry> lazy) {
    ...
    public static final NavBackStackEntry m147navGraphViewModels$lambda1(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m148navGraphViewModels$lambda2(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m149navGraphViewModels$lambda3(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
}
