        ...
        if (filters == null) {
            ...
            while (true) {
                ...
                if (!(filter instanceof InputFilter.LengthFilter)) {
                    ...
                    foundMaxLength = true;
                    boolean replace = ((InputFilter.LengthFilter) filter).getMax() != value;
                    if (replace) {
        ...
        if (before == null && after == null && on == null && textAttrChanged == null) {
            ...
            newValue = new TextWatcher() { // from class: androidx.databinding.adapters.TextViewBindingAdapter.1
                ...
                public void beforeTextChanged(CharSequence s, int start, int count, int after2) {
                    if (BeforeTextChanged.this != null) {
                        BeforeTextChanged.this.beforeTextChanged(s, start, count, after2);
                    }
                }
