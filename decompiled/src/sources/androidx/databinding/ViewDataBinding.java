...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    static {
        ...
        CREATE_PROPERTY_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.1
            ...
            public WeakListener create(ViewDataBinding viewDataBinding, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
        ...
        CREATE_LIST_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.2
            @Override // androidx.databinding.CreateWeakListener
            public WeakListener create(ViewDataBinding viewDataBinding, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
                return new WeakListListener(viewDataBinding, localFieldId, referenceQueue).getListener();
            }
        };
        CREATE_MAP_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.3
            @Override // androidx.databinding.CreateWeakListener
            public WeakListener create(ViewDataBinding viewDataBinding, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
                return new WeakMapListener(viewDataBinding, localFieldId, referenceQueue).getListener();
            }
        };
        CREATE_LIVE_DATA_LISTENER = new CreateWeakListener() { // from class: androidx.databinding.ViewDataBinding.4
            @Override // androidx.databinding.CreateWeakListener
            public WeakListener create(ViewDataBinding viewDataBinding, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
                return new LiveDataListener(viewDataBinding, localFieldId, referenceQueue).getListener();
            }
        };
    ...
    protected void handleFieldChange(int mLocalFieldId, Object object, int fieldId) {
        if (this.mInLiveDataRegisterObserver || this.mInStateFlowRegisterObserver) {
            return;
        }
    ...
    protected boolean updateRegistration(int localFieldId, Object observable, CreateWeakListener listenerCreator) {
        if (observable == null) {
    ...
    protected static double safeUnbox(Double boxed) {
        return boxed == null ? Utils.DOUBLE_EPSILON : boxed.doubleValue();
    }
    ...
    */
    ...
    private static class WeakPropertyListener extends Observable.OnPropertyChangedCallback implements ObservableReference<Observable> {
        ...
        public WeakPropertyListener(ViewDataBinding binder, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
            this.mListener = new WeakListener<>(binder, localFieldId, this, referenceQueue);
        }
    ...
    private static class WeakListListener extends ObservableList.OnListChangedCallback implements ObservableReference<ObservableList> {
        ...
        public WeakListListener(ViewDataBinding binder, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
            this.mListener = new WeakListener<>(binder, localFieldId, this, referenceQueue);
        }
    ...
    private static class WeakMapListener extends ObservableMap.OnMapChangedCallback implements ObservableReference<ObservableMap> {
        ...
        public WeakMapListener(ViewDataBinding binder, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
            this.mListener = new WeakListener<>(binder, localFieldId, this, referenceQueue);
        }
    ...
    private static class LiveDataListener implements Observer, ObservableReference<LiveData<?>> {
        ...
        public LiveDataListener(ViewDataBinding binder, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
            this.mListener = new WeakListener<>(binder, localFieldId, this, referenceQueue);
        }
