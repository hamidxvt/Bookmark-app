...
public final class ViewDataBindingKtx {
    ...
    public static final WeakListener CREATE_STATE_FLOW_LISTENER$lambda$0(ViewDataBinding viewDataBinding, int localFieldId, ReferenceQueue referenceQueue) {
        Intrinsics.checkNotNull(referenceQueue);
        return new StateFlowListener(viewDataBinding, localFieldId, referenceQueue).getListener();
    }
    ...
    public static final class StateFlowListener implements ObservableReference<Flow<? extends Object>> {
        ...
        public StateFlowListener(ViewDataBinding binder, int localFieldId, ReferenceQueue<ViewDataBinding> referenceQueue) {
            Intrinsics.checkNotNullParameter(referenceQueue, "referenceQueue");
            this.listener = new WeakListener<>(binder, localFieldId, this, referenceQueue);
        }
        ...
        public void addListener(Flow<? extends Object> target) {
            ...
            if (weakReference != null && (owner = weakReference.get()) != null && target != null) {
