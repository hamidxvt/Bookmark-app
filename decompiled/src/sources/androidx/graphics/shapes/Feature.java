    ...
    public static final class Corner extends Feature {
        ...
        */
        ...
        public Feature transformed$graphics_shapes_release(PointTransformer f) {
            ...
            return new Corner(CollectionsKt.build($this$transformed_u24lambda_u240), PointKt.m123transformedso9K2fw(this.vertex, f), PointKt.m123transformedso9K2fw(this.center, f), this.convex, null);
        }

        public String toString() {
            return "Corner: vertex=" + ((Object) FloatFloatPair.m19toStringimpl(this.vertex)) + ", center=" + ((Object) FloatFloatPair.m19toStringimpl(this.center)) + ", convex=" + this.convex;
        }
    }
}
