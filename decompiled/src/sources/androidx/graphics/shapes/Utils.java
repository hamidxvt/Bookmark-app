...
public final class Utils {
    ...
    public static final long directionVector(float x, float y) {
        ...
        if (d > 0.0f) {
            return FloatFloatPair.m12constructorimpl(x / d, y / d);
        }
    ...
    public static final long directionVector(float angleRadians) {
        return FloatFloatPair.m12constructorimpl((float) Math.cos(angleRadians), (float) Math.sin(angleRadians));
    }
    ...
    public static /* synthetic */ long m136radialToCartesianL6JJ3z0$default(float f, float f2, long j, int i, Object obj) {
        if ((i & 4) != 0) {
            j = Zero;
        }
        return m135radialToCartesianL6JJ3z0(f, f2, j);
    }

    /* renamed from: radialToCartesian-L6JJ3z0, reason: not valid java name */
    public static final long m135radialToCartesianL6JJ3z0(float radius, float angleRadians, long center) {
        return PointKt.m120plusybeJwSQ(PointKt.m122timesso9K2fw(directionVector(angleRadians), radius), center);
    }

    /* renamed from: rotate90-DnnuFBc, reason: not valid java name */
    public static final long m137rotate90DnnuFBc(long $this$rotate90_u2dDnnuFBc) {
        return FloatFloatPair.m12constructorimpl(-PointKt.m117getYDnnuFBc($this$rotate90_u2dDnnuFBc), PointKt.m116getXDnnuFBc($this$rotate90_u2dDnnuFBc));
    }
