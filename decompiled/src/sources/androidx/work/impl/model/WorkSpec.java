...
public final /* data */ class WorkSpec {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((((((((((((((((((((this.id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31) + (this.inputMergerClassName == null ? 0 : this.inputMergerClassName.hashCode())) * 31) + this.input.hashCode()) * 31) + this.output.hashCode()) * 31) + Long.hashCode(this.initialDelay)) * 31) + Long.hashCode(this.intervalDuration)) * 31) + Long.hashCode(this.flexDuration)) * 31) + this.constraints.hashCode()) * 31) + Integer.hashCode(this.runAttemptCount)) * 31) + this.backoffPolicy.hashCode()) * 31) + Long.hashCode(this.backoffDelayDuration)) * 31) + Long.hashCode(this.lastEnqueueTime)) * 31) + Long.hashCode(this.minimumRetentionDuration)) * 31) + Long.hashCode(this.scheduleRequestedAt)) * 31;
        boolean z = this.expedited;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        return ((((((hashCode + i) * 31) + this.outOfQuotaPolicy.hashCode()) * 31) + Integer.hashCode(this.periodCount)) * 31) + Integer.hashCode(this.generation);
    }
    ...
    */
    ...
    public final long calculateNextRunTime() {
        if (isBackedOff()) {
            ...
            long delay = isLinearBackoff ? this.backoffDelayDuration * this.runAttemptCount : (long) Math.scalb(this.backoffDelayDuration, this.runAttemptCount - 1);
            return this.lastEnqueueTime + RangesKt.coerceAtMost(delay, WorkRequest.MAX_BACKOFF_MILLIS);
        }
        if (isPeriodic()) {
            int i = this.periodCount;
            long start = this.lastEnqueueTime;
            if (i == 0) {
                start += this.initialDelay;
            }
            boolean isFlexApplicable = this.flexDuration != this.intervalDuration;
            if (isFlexApplicable) {
                long offset = this.periodCount == 0 ? this.flexDuration * (-1) : 0L;
                return this.intervalDuration + start + offset;
            }
            long offset2 = this.periodCount != 0 ? this.intervalDuration : 0L;
            return start + offset2;
        }
        return (this.lastEnqueueTime == 0 ? System.currentTimeMillis() : this.lastEnqueueTime) + this.initialDelay;
    }
    ...
    public static final /* data */ class WorkInfoPojo {
        ...
        public WorkInfoPojo(String id, WorkInfo.State state, Data output, int runAttemptCount, int generation, List<String> tags, List<Data> progress) {
            Intrinsics.checkNotNullParameter(id, "id");
            Intrinsics.checkNotNullParameter(state, "state");
            Intrinsics.checkNotNullParameter(output, "output");
            Intrinsics.checkNotNullParameter(tags, "tags");
        ...
        public final WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.id), this.state, this.output, this.tags, progress, this.runAttemptCount, this.generation);
        }
    }
