...
public class WorkerWrapper implements Runnable {
        ...
        try {
            ...
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    WorkerWrapper.this.m184lambda$runWorker$0$androidxworkimplWorkerWrapper(runExpedited);
                }
    ...
    /* synthetic */ void m184lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture runExpedited) {
    ...
    private void resolve(final boolean needsReschedule) {
        ...
        try {
            ...
            if (this.mWorkSpec != null && this.mWorker != null) {
                boolean isInForeground = this.mForegroundProcessor.isEnqueuedInForeground(this.mWorkSpecId);
                if (isInForeground) {
