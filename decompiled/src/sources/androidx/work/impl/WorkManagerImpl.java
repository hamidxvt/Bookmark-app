...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(Context context, Configuration configuration, TaskExecutor workTaskExecutor, WorkDatabase database) {
        ...
        this.mTrackers = new Trackers(applicationContext, workTaskExecutor);
        List<Scheduler> schedulers = createSchedulers(applicationContext, configuration, this.mTrackers);
        Processor processor = new Processor(context, configuration, workTaskExecutor, database, schedulers);
