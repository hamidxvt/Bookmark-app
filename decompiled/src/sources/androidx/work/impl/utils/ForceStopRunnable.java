...
public class ForceStopRunnable implements Runnable {
                ...
                try {
                    ...
                    try {
                        ...
                        if (this.mRetryCount >= 3) {
                            Logger.get().error(TAG, "The file system on the device is in a bad state. WorkManager cannot access the app's internal data store.", exception);
    ...
    public boolean cleanUp() {
        boolean needsReconciling = SystemJobScheduler.reconcileJobs(this.mContext, this.mWorkManager);
