...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mUpdateThrottle != 0) {
            ...
            writer.print(this.mLastLoadCompleteTime == -10000 ? "--" : "-" + DateUtils.formatElapsedTime(TimeUnit.MILLISECONDS.toSeconds(SystemClock.uptimeMillis() - this.mLastLoadCompleteTime)));
            writer.println();
        }
    }
}
