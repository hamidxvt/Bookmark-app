...
public class MotionScene {
    ...
    private int getId(Context context, String idString) {
        ...
        if (idString.contains("/")) {
            ...
            id = context.getResources().getIdentifier(tmp, Constant.VISIT_ID, context.getPackageName());
        }
        if (id == -1) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (name.hashCode()) {
                ...
                case -1153153640:
                    ...
                    break;
                case 3355:
                    if (name.equals(Constant.VISIT_ID)) {
                        r0 = z;
                        break;
                    }
                    r0 = -1;
            ...
            switch (event.getAction()) {
                ...
                case 2:
                    if (!this.mIgnoreTouch) {
                        ...
                        if ((dx == Utils.DOUBLE_EPSILON && dy == Utils.DOUBLE_EPSILON) || this.mLastTouchDown == null) {
                            return;
                        }
