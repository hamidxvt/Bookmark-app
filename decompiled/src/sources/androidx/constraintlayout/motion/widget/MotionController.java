...
public class MotionController {
    ...
    /* JADX WARN: Incorrect condition in loop: B:21:0x0083 */
    /*
    ...
    boolean interpolate(View child, float globalPosition, long time, KeyCache keyCache) {
        ...
        if (this.mSpline != null) {
            ...
            for (int i = 1; i < this.mSpline.length; i++) {
                ...
                CustomSupport.setInterpolatedValue(this.mStartMotionPath.mAttributes.get(this.mAttributeNames[i - 1]), child, this.mValuesBuff);
            }
