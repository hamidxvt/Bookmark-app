...
public class ConstraintSetParser {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (base_element instanceof CLObject) {
                    ...
                    CLObject customProperties = element.getObjectOrNull(SchedulerSupport.CUSTOM);
    ...
    */
        ...
        while (it.hasNext()) {
            ...
            switch (elementName.hashCode()) {
                case -1824489883:
                    ...
                    break;
                case 1875016085:
                    if (elementName.equals("Generate")) {
                        z = 2;
                        break;
                    }
                    z = -1;
    ...
    private static void parseVariables(State state, LayoutVariables layoutVariables, CLObject json) throws CLParsingException {
        ...
        while (it.hasNext()) {
            ...
            if (element instanceof CLNumber) {
                ...
                if (obj.has("from") && obj.has(TypedValues.TransitionType.S_TO)) {
    ...
    static void parseGuideline(int orientation, State state, CLArray helper) throws CLParsingException {
        ...
        if ((params instanceof CLObject) && (guidelineId = ((CLObject) params).getStringOrNull(Constant.VISIT_ID)) != null) {
    ...
    */
    static void parseBarrier(State state, String elementName, CLObject element) throws CLParsingException {
        ...
        while (it.hasNext()) {
            ...
            switch (constraintName.hashCode()) {
                case -1081309778:
                    if (constraintName.equals("margin")) {
                        z = true;
                        break;
                    }
                    z = -1;
                    break;
                case -962590849:
                    if (constraintName.equals("direction")) {
                        z = false;
                        break;
                    }
                    z = -1;
                    break;
                case -567445985:
                    if (constraintName.equals("contains")) {
                        z = 2;
                        break;
                    }
                    z = -1;
    ...
    static void applyAttribute(State state, LayoutVariables layoutVariables, ConstraintReference reference, CLObject element, String attributeName) throws CLParsingException {
        ...
        switch (attributeName.hashCode()) {
            ...
            case -1364013995:
                ...
                break;
            case -1349088399:
                if (attributeName.equals(SchedulerSupport.CUSTOM)) {
                    c = 22;
                    break;
                }
                c = 65535;
    ...
    static void parseConstraint(State state, LayoutVariables layoutVariables, CLObject element, ConstraintReference reference, String constraintName) throws CLParsingException {
        ...
        if (constraint == null || constraint.size() <= 1) {
            ...
            if (target != null) {
                ...
                switch (constraintName.hashCode()) {
                    case -1720785339:
                        if (constraintName.equals("baseline")) {
                            c2 = 4;
                            break;
                        }
                        c2 = 65535;
                        break;
                    case -1383228885:
                        if (constraintName.equals("bottom")) {
                            c2 = 3;
                            break;
                        }
                        c2 = 65535;
        ...
        String target2 = constraint.getString(0);
        ...
        if (constraint.size() > 3) {
            CLElement arg22 = constraint.getOrNull(3);
            float marginGone2 = layoutVariables.get(arg22);
            marginGone = toPix(state, marginGone2);
        }
        if (target2.equals("parent")) {
            targetReference2 = state.constraints(State.PARENT);
        } else {
            targetReference2 = state.constraints(target2);
        }
