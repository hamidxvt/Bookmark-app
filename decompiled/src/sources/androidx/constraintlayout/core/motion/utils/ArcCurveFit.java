...
public class ArcCurveFit extends CurveFit {
    ...
    private static class Arc {
        ...
        Arc(int mode, double t1, double t2, double x1, double y1, double x2, double y2) {
            ...
            switch (mode) {
                ...
                default:
                    ...
                    break;
                case 4:
                    this.mVertical = dy2 > com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON;
                    break;
                case 5:
                    this.mVertical = dy2 < com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON;
                    break;
            ...
            if (this.mLinear || Math.abs(dx) < EPSILON) {
                ...
                if (Math.abs(dy2) >= EPSILON) {
                    ...
                    this.mEllipseB = (this.mVertical ? 1 : -1) * dy2;
            ...
            this.mY2 = y2;
            double dy3 = dy;
            this.mArcDistance = Math.hypot(dy3, dx);
            this.mArcVelocity = this.mArcDistance * this.mOneOverDeltaTime;
        ...
        double lookup(double v) {
            if (v <= com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON) {
        ...
        private void buildTable(double x1, double y1, double x2, double y2) {
            ...
            double a2 = x2 - x1;
            double b2 = y1 - y2;
            double lx = com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON;
            double ly = com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON;
            double dist = com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON;
            int i = 0;
            while (i < sOurPercent.length) {
                double angle = Math.toRadians((i * 90.0d) / (sOurPercent.length - 1));
