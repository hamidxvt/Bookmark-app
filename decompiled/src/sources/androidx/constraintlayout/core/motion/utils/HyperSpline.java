...
public class HyperSpline {
    ...
    public double approxLength(Cubic[] curve) {
        ...
        for (double i = com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON; i < 1.0d; i += 0.1d) {
            ...
            if (i > com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON) {
                sum += Math.sqrt(s);
            }
        }
        double s2 = com.github.mikephil.charting.utils.Utils.DOUBLE_EPSILON;
