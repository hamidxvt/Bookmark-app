    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
            ...
            if (this.mResolvedHorizontal) {
                ...
                if (z2 && this.mParent != null) {
                    if (this.mOptimizeWrapOnResolved) {
                        ...
                        linearSystem.addGreaterThan(linearSystem.createObjectVariable(this.mParent.mRight), createObjectVariable2, 0, 5);
                    }
                }
            }
            if (this.mResolvedVertical) {
                ...
                if (z3 && this.mParent != null) {
                    if (this.mOptimizeWrapOnResolved) {
                        ...
                        linearSystem.addGreaterThan(linearSystem.createObjectVariable(this.mParent.mBottom), createObjectVariable4, 0, 5);
                    }
                }
            }
            if (this.mResolvedHorizontal && this.mResolvedVertical) {
        ...
        if (this.mHorizontalResolution == 2 || this.mResolvedHorizontal) {
            ...
            if (z && this.mHorizontalRun != null && this.mHorizontalRun.start.resolved) {
                if (!this.mHorizontalRun.end.resolved) {
                    c = '\b';
                } else if (z) {
                    linearSystem.addEquality(createObjectVariable, this.mHorizontalRun.start.value);
                    linearSystem.addEquality(createObjectVariable2, this.mHorizontalRun.end.value);
                    if (this.mParent == null) {
                        ...
                        solverVariable4 = createObjectVariable2;
                        solverVariable5 = createObjectVariable;
                    } else if (!z2 || !this.isTerminalWidget[0]) {
                        z8 = z3;
                        z9 = z2;
                        z10 = z6;
                        solverVariable = createObjectVariable5;
            ...
            SolverVariable createObjectVariable6 = this.mParent != null ? linearSystem.createObjectVariable(this.mParent.mRight) : null;
            z8 = z3;
            z9 = z2;
            z10 = z6;
            solverVariable = createObjectVariable5;
            ...
            solverVariable4 = createObjectVariable2;
            solverVariable5 = createObjectVariable;
            applyConstraints(linearSystem, true, z2, z8, this.isTerminalWidget[0], this.mParent != null ? linearSystem.createObjectVariable(this.mParent.mLeft) : null, createObjectVariable6, this.mListDimensionBehaviors[0], z21, this.mLeft, this.mRight, this.mX, i5, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z19, this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT, z4, z5, z22, i2, i, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z7);
        }
        boolean z24 = true;
        if (z) {
            constraintWidget = this;
            if (constraintWidget.mVerticalRun != null && constraintWidget.mVerticalRun.start.resolved && constraintWidget.mVerticalRun.end.resolved) {
                linearSystem2 = linearSystem;
                solverVariable8 = solverVariable3;
                linearSystem2.addEquality(solverVariable8, constraintWidget.mVerticalRun.start.value);
                solverVariable7 = solverVariable2;
                linearSystem2.addEquality(solverVariable7, constraintWidget.mVerticalRun.end.value);
                solverVariable6 = solverVariable;
                linearSystem2.addEquality(solverVariable6, constraintWidget.mVerticalRun.baseline.value);
                ...
                if (!z11 && !constraintWidget.mResolvedVertical) {
                    ...
                    SolverVariable createObjectVariable7 = constraintWidget.mParent != null ? linearSystem2.createObjectVariable(constraintWidget.mParent.mBottom) : null;
                    SolverVariable createObjectVariable8 = constraintWidget.mParent != null ? linearSystem2.createObjectVariable(constraintWidget.mParent.mTop) : null;
                    if (constraintWidget.mBaselineDistance > 0 || constraintWidget.mVisibility == i6) {
                        if (constraintWidget.mBaseline.mTarget != null) {
                            ...
                            if (z8) {
                                linearSystem2.addGreaterThan(createObjectVariable7, linearSystem2.createObjectVariable(constraintWidget.mBottom), i7, 5);
                            }
                            z12 = false;
                            applyConstraints(linearSystem, false, z8, z9, constraintWidget.isTerminalWidget[r2], createObjectVariable8, createObjectVariable7, constraintWidget.mListDimensionBehaviors[r2], z25, constraintWidget.mTop, constraintWidget.mBottom, constraintWidget.mY, i8, constraintWidget.mMinHeight, constraintWidget.mMaxDimension[r2], constraintWidget.mVerticalBiasPercent, z20, constraintWidget.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT, z5, z4, z23, i, i2, constraintWidget.mMatchConstraintMinHeight, constraintWidget.mMatchConstraintMaxHeight, constraintWidget.mMatchConstraintPercentHeight, z12);
                        } else if (constraintWidget.mVisibility == i6) {
                ...
                constraintWidget.mResolvedHorizontal = false;
                constraintWidget.mResolvedVertical = false;
                if (LinearSystem.sMetrics == null) {
                ...
                if (isBeginConnected || isEndConnected || isCenterConnected) {
                    if (isBeginConnected && !isEndConnected) {
                        ...
                        if (!parentWrapContent) {
                            ...
                            endTarget2 = endTarget;
                        } else if (this.mOptimizeWrapO && begin4.isFinalValue && this.mParent != null) {
                    ...
                    if (endTarget2 != parentMax) {
                        if (!constraintWidget2.mOptimizeWrapO || !end3.isFinalValue || constraintWidget2.mParent == null) {
                            system.addGreaterThan(parentMax, end3, margin3, matchConstraintDefault2);
                            return;
                        }
                        ConstraintWidgetContainer container2 = (ConstraintWidgetContainer) constraintWidget2.mParent;
                        if (isHorizontal) {
