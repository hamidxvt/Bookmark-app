...
public class ChainRun extends WidgetRun {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:295:0x0458, code lost:
            ...
            while (i5 < count) {
                ...
                if (run.mWidget.getVisibility() == i) {
                    ...
                    if (treatAsFixed3) {
                        ...
                        if (treatAsFixed2) {
                            numMatchConstraints++;
                            float weight = run.mWidget.mWeight[chainRun.orientation];
                            if (weight >= 0.0f) {
                                weights2 += weight;
                            }
                        } else {
        ...
        if (numMatchConstraints > 0) {
            ...
            while (i6 < count) {
                ...
                if (run2.mWidget.getVisibility() == 8) {
                    ...
                    if (weights2 > 0.0f) {
                        dimension2 = (int) ((((distance - size2) * run2.mWidget.mWeight[chainRun.orientation]) / weights2) + 0.5f);
                    }
                    ...
                    if (size3 == 0) {
                        ...
                        float f = weights2;
                        min = run2.mWidget.mMatchConstraintMinWidth;
                        max = max2;
                        weights = f;
                    } else {
                        int max3 = run2.mWidget.mMatchConstraintMaxHeight;
                        float f2 = weights2;
                        min = run2.mWidget.mMatchConstraintMinHeight;
                        max = max3;
                        weights = f2;
                    }
                    matchConstraintsDimension = matchConstraintsDimension2;
            ...
            if (appliedLimits <= 0) {
                ...
                for (int i7 = 0; i7 < count; i7++) {
                    WidgetRun run3 = chainRun.mWidgets.get(i7);
