...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m2084getOrNullimpl = ChannelResult.m2084getOrNullimpl(((SimpleActor) this).messageQueue.mo2072tryReceivePtdJZtk());
                        if (m2084getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m2084getOrNullimpl, th);
                            obj = Unit.INSTANCE;
                        } else {
                            obj = null;
                        }
    ...
    public final void offer(T msg) {
        Object $this$onClosed_u2dWpGqRn0$iv = this.messageQueue.mo2064trySendJP2dKIU(msg);
        if (!($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed)) {
            if (!ChannelResult.m2089isSuccessimpl($this$onClosed_u2dWpGqRn0$iv)) {
        ...
        Throwable it = ChannelResult.m2083exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
        if (it != null) {
            throw it;
        }
    }
