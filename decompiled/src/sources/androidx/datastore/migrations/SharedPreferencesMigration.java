...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    */
    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, Function2 function2, Function3 function3, Context context, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) set, r3, function3, context, str);
        Function2 function22;
        if ((i & 4) == 0) {
            function22 = function2;
        } else {
            function22 = new AnonymousClass1(null);
        }
    }
    ...
    */
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, Function2 function2, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, r3, r4, function3);
        Set set2;
        Function2 function22;
        if ((i & 4) == 0) {
            set2 = set;
        } else {
            set2 = SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS();
        }
        if ((i & 8) == 0) {
            function22 = function2;
        } else {
            function22 = new AnonymousClass3(null);
        }
    }
    ...
    */
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) {
        ...
        SharedPreferencesMigration$shouldMigrate$1 sharedPreferencesMigration$shouldMigrate$12;
        ...
        if (continuation instanceof SharedPreferencesMigration$shouldMigrate$1) {
            ...
            if ((sharedPreferencesMigration$shouldMigrate$1.label & Integer.MIN_VALUE) != 0) {
                ...
                sharedPreferencesMigration$shouldMigrate$12 = sharedPreferencesMigration$shouldMigrate$1;
                Object $result = sharedPreferencesMigration$shouldMigrate$12.result;
                Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                boolean z = true;
                switch (sharedPreferencesMigration$shouldMigrate$12.label) {
                    case 0:
                        ...
                        sharedPreferencesMigration$shouldMigrate$12.L$0 = sharedPreferencesMigration;
                        sharedPreferencesMigration$shouldMigrate$12.label = 1;
                        currentData = function2.invoke(t, sharedPreferencesMigration$shouldMigrate$12);
                        if (currentData == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        break;
                    case 1:
                        SharedPreferencesMigration sharedPreferencesMigration2 = (SharedPreferencesMigration) sharedPreferencesMigration$shouldMigrate$12.L$0;
                        ResultKt.throwOnFailure($result);
                        sharedPreferencesMigration = sharedPreferencesMigration2;
                        currentData = $result;
                        break;
                    default:
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        ...
        sharedPreferencesMigration$shouldMigrate$12 = sharedPreferencesMigration$shouldMigrate$1;
        Object $result2 = sharedPreferencesMigration$shouldMigrate$12.result;
