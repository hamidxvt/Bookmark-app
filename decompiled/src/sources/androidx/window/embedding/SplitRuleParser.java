    ...
    private final ComponentName buildClassName(String pkg, CharSequence clsSeq) {
        if (clsSeq != null) {
            if (!(clsSeq.length() == 0)) {
                ...
                if (!Intrinsics.areEqual(clsString, "*") && StringsKt.indexOf$default((CharSequence) clsString, ClassUtils.PACKAGE_SEPARATOR_CHAR, 0, false, 6, (Object) null) < 0) {
                    return new ComponentName(pkgString, pkgString + ClassUtils.PACKAGE_SEPARATOR_CHAR + clsString);
                }
