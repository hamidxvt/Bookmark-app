...
public abstract class ProtectedSignalsManagerFutures {
    ...
    static final class JavaImpl extends ProtectedSignalsManagerFutures {
        ...
        public JavaImpl(ProtectedSignalsManager mProtectedSignalsManager) {
            this.mProtectedSignalsManager = mProtectedSignalsManager;
        }
    ...
    public static final class Companion {
        ...
        public final ProtectedSignalsManagerFutures from(Context context) {
            ...
            ProtectedSignalsManager it = ProtectedSignalsManager.INSTANCE.obtain(context);
            return it != null ? new JavaImpl(it) : null;
        }
    }
