...
public abstract class CustomAudienceManagerFutures {
    ...
    static final class Api33Ext4JavaImpl extends CustomAudienceManagerFutures {
        ...
        public Api33Ext4JavaImpl(CustomAudienceManager mCustomAudienceManager) {
    ...
    public static final class Companion {
        ...
        public final CustomAudienceManagerFutures from(Context context) {
            ...
            CustomAudienceManager it = CustomAudienceManager.INSTANCE.obtain(context);
            return it != null ? new Api33Ext4JavaImpl(it) : null;
        }
    }
