...
public final class AdSelectionConfig {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof AdSelectionConfig) {
            return Intrinsics.areEqual(this.seller, ((AdSelectionConfig) other).seller) && Intrinsics.areEqual(this.decisionLogicUri, ((AdSelectionConfig) other).decisionLogicUri) && Intrinsics.areEqual(this.customAudienceBuyers, ((AdSelectionConfig) other).customAudienceBuyers) && Intrinsics.areEqual(this.adSelectionSignals, ((AdSelectionConfig) other).adSelectionSignals) && Intrinsics.areEqual(this.sellerSignals, ((AdSelectionConfig) other).sellerSignals) && Intrinsics.areEqual(this.perBuyerSignals, ((AdSelectionConfig) other).perBuyerSignals) && Intrinsics.areEqual(this.trustedScoringSignalsUri, ((AdSelectionConfig) other).trustedScoringSignalsUri);
        }
        return false;
    }

    public int hashCode() {
        int hash = this.seller.hashCode();
        return (((((((((((hash * 31) + this.decisionLogicUri.hashCode()) * 31) + this.customAudienceBuyers.hashCode()) * 31) + this.adSelectionSignals.hashCode()) * 31) + this.sellerSignals.hashCode()) * 31) + this.perBuyerSignals.hashCode()) * 31) + this.trustedScoringSignalsUri.hashCode();
    }
    ...
    private final List<android.adservices.common.AdTechIdentifier> convertToAdServices(List<AdTechIdentifier> list) {
        ...
        for (AdTechIdentifier buyer : list) {
            ids.add(buyer.convertToAdServices$ads_adservices_release());
        }
        return ids;
    }
    ...
    private final Map<android.adservices.common.AdTechIdentifier, android.adservices.common.AdSelectionSignals> convertToAdServices(Map<AdTechIdentifier, AdSelectionSignals> map) {
        ...
        for (AdTechIdentifier key : map.keySet()) {
            android.adservices.common.AdTechIdentifier id = key.convertToAdServices$ads_adservices_release();
            AdSelectionSignals adSelectionSignals = map.get(key);
            android.adservices.common.AdSelectionSignals value = adSelectionSignals != null ? adSelectionSignals.convertToAdServices$ads_adservices_release() : null;
            map2.put(id, value);
        }
        return map2;
    }
