...
public final class ReportEventRequest {
    ...
    public ReportEventRequest(long adSelectionId, String eventKey, String eventData, int reportingDestinations, InputEvent inputEvent) {
        Intrinsics.checkNotNullParameter(eventKey, "eventKey");
        Intrinsics.checkNotNullParameter(eventData, "eventData");
        this.adSelectionId = adSelectionId;
        this.eventKey = eventKey;
        this.eventData = eventData;
        this.reportingDestinations = reportingDestinations;
        this.inputEvent = inputEvent;
        if (this.reportingDestinations > 0 && this.reportingDestinations <= 3) {
        } else {
    ...
    */
    ...
    public ReportEventRequest(long adSelectionId, String eventKey, String eventData, int reportingDestinations) {
        this(adSelectionId, eventKey, eventData, reportingDestinations, null, 16, null);
        Intrinsics.checkNotNullParameter(eventKey, "eventKey");
        Intrinsics.checkNotNullParameter(eventData, "eventData");
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof ReportEventRequest) {
            return this.adSelectionId == ((ReportEventRequest) other).adSelectionId && Intrinsics.areEqual(this.eventKey, ((ReportEventRequest) other).eventKey) && Intrinsics.areEqual(this.eventData, ((ReportEventRequest) other).eventData) && this.reportingDestinations == ((ReportEventRequest) other).reportingDestinations && Intrinsics.areEqual(this.inputEvent, ((ReportEventRequest) other).inputEvent);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hash2 = ((((((hash * 31) + this.eventKey.hashCode()) * 31) + this.eventData.hashCode()) * 31) + Integer.hashCode(this.reportingDestinations)) * 31;
        InputEvent inputEvent = this.inputEvent;
        return hash2 + (inputEvent != null ? inputEvent.hashCode() : 0);
    }
