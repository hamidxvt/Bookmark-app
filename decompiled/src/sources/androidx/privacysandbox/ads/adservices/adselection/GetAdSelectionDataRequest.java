...
public final class GetAdSelectionDataRequest {
    ...
    public GetAdSelectionDataRequest(AdTechIdentifier seller, Uri coordinatorOriginUri) {
        Intrinsics.checkNotNullParameter(seller, "seller");
        this.seller = seller;
        this.coordinatorOriginUri = coordinatorOriginUri;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof GetAdSelectionDataRequest) {
            return Intrinsics.areEqual(this.seller, ((GetAdSelectionDataRequest) other).seller) && Intrinsics.areEqual(this.coordinatorOriginUri, ((GetAdSelectionDataRequest) other).coordinatorOriginUri);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hash2 = i + (uri != null ? uri.hashCode() : 0);
        return hash2;
    }
