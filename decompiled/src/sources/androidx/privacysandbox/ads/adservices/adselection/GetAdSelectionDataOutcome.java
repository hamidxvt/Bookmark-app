...
public final class GetAdSelectionDataOutcome {
    ...
    public GetAdSelectionDataOutcome(long adSelectionId) {
        this(adSelectionId, null, 2, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof GetAdSelectionDataOutcome) {
            return this.adSelectionId == ((GetAdSelectionDataOutcome) other).adSelectionId && Arrays.equals(this.adSelectionData, ((GetAdSelectionDataOutcome) other).adSelectionData);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hash2 = i + (bArr != null ? bArr.hashCode() : 0);
        return hash2;
    }
