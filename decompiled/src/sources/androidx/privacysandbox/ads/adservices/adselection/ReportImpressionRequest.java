...
public final class ReportImpressionRequest {
    ...
    public ReportImpressionRequest(long adSelectionId) {
        this(adSelectionId, AdSelectionConfig.INSTANCE.getEMPTY());
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof ReportImpressionRequest) {
            return this.adSelectionId == ((ReportImpressionRequest) other).adSelectionId && Intrinsics.areEqual(this.adSelectionConfig, ((ReportImpressionRequest) other).adSelectionConfig);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (hash * 31) + this.adSelectionConfig.hashCode();
    }
