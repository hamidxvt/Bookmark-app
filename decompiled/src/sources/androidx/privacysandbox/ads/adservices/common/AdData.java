...
public final class AdData {
    ...
    public AdData(Uri renderUri, String metadata, Set<Integer> adCounterKeys, AdFilters adFilters, String adRenderId) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof AdData) {
            return Intrinsics.areEqual(this.renderUri, ((AdData) other).renderUri) && Intrinsics.areEqual(this.metadata, ((AdData) other).metadata) && Intrinsics.areEqual(this.adCounterKeys, ((AdData) other).adCounterKeys) && Intrinsics.areEqual(this.adFilters, ((AdData) other).adFilters) && Intrinsics.areEqual(this.adRenderId, ((AdData) other).adRenderId);
        }
        return false;
    }

    public int hashCode() {
        int hash = this.renderUri.hashCode();
        int hash2 = ((((hash * 31) + this.metadata.hashCode()) * 31) + this.adCounterKeys.hashCode()) * 31;
        AdFilters adFilters = this.adFilters;
        int hash3 = (hash2 + (adFilters != null ? adFilters.hashCode() : 0)) * 31;
        String str = this.adRenderId;
        return hash3 + (str != null ? str.hashCode() : 0);
    }
