...
public final class FrequencyCapFilters {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof FrequencyCapFilters) {
            return Intrinsics.areEqual(this.keyedFrequencyCapsForWinEvents, ((FrequencyCapFilters) other).keyedFrequencyCapsForWinEvents) && Intrinsics.areEqual(this.keyedFrequencyCapsForImpressionEvents, ((FrequencyCapFilters) other).keyedFrequencyCapsForImpressionEvents) && Intrinsics.areEqual(this.keyedFrequencyCapsForViewEvents, ((FrequencyCapFilters) other).keyedFrequencyCapsForViewEvents) && Intrinsics.areEqual(this.keyedFrequencyCapsForClickEvents, ((FrequencyCapFilters) other).keyedFrequencyCapsForClickEvents);
        }
        return false;
    }

    public int hashCode() {
        int hash = this.keyedFrequencyCapsForWinEvents.hashCode();
        return (((((hash * 31) + this.keyedFrequencyCapsForImpressionEvents.hashCode()) * 31) + this.keyedFrequencyCapsForViewEvents.hashCode()) * 31) + this.keyedFrequencyCapsForClickEvents.hashCode();
    }
    ...
    private final List<android.adservices.common.KeyedFrequencyCap> convertToAdServices(List<KeyedFrequencyCap> list) {
        ...
        for (KeyedFrequencyCap keyedFrequencyCap : list) {
            result.add(keyedFrequencyCap.convertToAdServices$ads_adservices_release());
        }
        return result;
    }
}
