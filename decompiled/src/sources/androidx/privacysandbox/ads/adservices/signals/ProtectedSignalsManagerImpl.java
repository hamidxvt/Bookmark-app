...
public class ProtectedSignalsManagerImpl extends ProtectedSignalsManager {
    ...
    static /* synthetic */ Object updateSignals$suspendImpl(ProtectedSignalsManagerImpl $this, UpdateSignalsRequest request, Continuation<? super Unit> continuation) {
        CancellableContinuationImpl cancellable$iv = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        cancellable$iv.initCancellability();
        CancellableContinuationImpl continuation2 = cancellable$iv;
        $this.protectedSignalsManager.updateSignals($this.convertUpdateRequest(request), new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), OutcomeReceiverKt.asOutcomeReceiver(continuation2));
