...
public final class WebTriggerRegistrationRequest {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof WebTriggerRegistrationRequest) {
            return Intrinsics.areEqual(this.webTriggerParams, ((WebTriggerRegistrationRequest) other).webTriggerParams) && Intrinsics.areEqual(this.Destination, ((WebTriggerRegistrationRequest) other).Destination);
        }
        return false;
    }

    public int hashCode() {
        int hash = this.webTriggerParams.hashCode();
        return (hash * 31) + this.Destination.hashCode();
    }
