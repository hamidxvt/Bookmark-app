...
public final class DeletionRequest {
    ...
    public DeletionRequest(int deletionMode, int matchBehavior, Instant start, Instant end, List<? extends Uri> domainUris, List<? extends Uri> originUris) {
    ...
    */
    public /* synthetic */ DeletionRequest(int i, int i2, Instant instant, Instant instant2, List list, List list2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, i2, r3, r4, (i3 & 16) != 0 ? CollectionsKt.emptyList() : list, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list2);
        Instant instant3;
        Instant instant4;
        if ((i3 & 4) != 0) {
    ...
    public int hashCode() {
        int hash = Integer.hashCode(this.deletionMode);
        return (((((((((hash * 31) + this.domainUris.hashCode()) * 31) + this.originUris.hashCode()) * 31) + this.start.hashCode()) * 31) + this.end.hashCode()) * 31) + Integer.hashCode(this.matchBehavior);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof DeletionRequest) {
            return this.deletionMode == ((DeletionRequest) other).deletionMode && Intrinsics.areEqual(new HashSet(this.domainUris), new HashSet(((DeletionRequest) other).domainUris)) && Intrinsics.areEqual(new HashSet(this.originUris), new HashSet(((DeletionRequest) other).originUris)) && Intrinsics.areEqual(this.start, ((DeletionRequest) other).start) && Intrinsics.areEqual(this.end, ((DeletionRequest) other).end) && this.matchBehavior == ((DeletionRequest) other).matchBehavior;
        }
        return false;
    }

    public String toString() {
        String deletionModeStr = this.deletionMode == 0 ? "DELETION_MODE_ALL" : "DELETION_MODE_EXCLUDE_INTERNAL_DATA";
        String matchBehaviorStr = this.matchBehavior == 0 ? "MATCH_BEHAVIOR_DELETE" : "MATCH_BEHAVIOR_PRESERVE";
        return "DeletionRequest { DeletionMode=" + deletionModeStr + ", MatchBehavior=" + matchBehaviorStr + ", Start=" + this.start + ", End=" + this.end + ", DomainUris=" + this.domainUris + ", OriginUris=" + this.originUris + " }";
    }
    ...
    public static final class Builder {
        ...
        public final Builder setStart(Instant start) {
            Intrinsics.checkNotNullParameter(start, "start");
            Builder $this$setStart_u24lambda_u240 = this;
            $this$setStart_u24lambda_u240.start = start;
            return this;
        }

        public final Builder setEnd(Instant end) {
            Intrinsics.checkNotNullParameter(end, "end");
            Builder $this$setEnd_u24lambda_u241 = this;
            $this$setEnd_u24lambda_u241.end = end;
            return this;
        }

        public final Builder setDomainUris(List<? extends Uri> domainUris) {
            Intrinsics.checkNotNullParameter(domainUris, "domainUris");
            Builder $this$setDomainUris_u24lambda_u242 = this;
            $this$setDomainUris_u24lambda_u242.domainUris = domainUris;
            return this;
        }

        public final Builder setOriginUris(List<? extends Uri> originUris) {
            Intrinsics.checkNotNullParameter(originUris, "originUris");
            Builder $this$setOriginUris_u24lambda_u243 = this;
            $this$setOriginUris_u24lambda_u243.originUris = originUris;
            return this;
        }
