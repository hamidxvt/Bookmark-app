...
public final class WebSourceParams {
    ...
    public WebSourceParams(Uri registrationUri, boolean debugKeyAllowed) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof WebSourceParams) {
            return Intrinsics.areEqual(this.registrationUri, ((WebSourceParams) other).registrationUri) && this.DebugKeyAllowed == ((WebSourceParams) other).DebugKeyAllowed;
        }
        return false;
    }
    ...
    public static final class Companion {
        ...
        public final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams$ads_adservices_release(List<WebSourceParams> request) {
            ...
            for (WebSourceParams param : request) {
                android.adservices.measurement.WebSourceParams build = new WebSourceParams.Builder(param.getRegistrationUri()).setDebugKeyAllowed(param.getDebugKeyAllowed()).build();
