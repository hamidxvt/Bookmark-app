...
public final class CustomAudience {
    ...
    public CustomAudience(AdTechIdentifier buyer, String name, Uri dailyUpdateUri, Uri biddingLogicUri, List<AdData> ads, Instant activationTime, Instant expirationTime, AdSelectionSignals userBiddingSignals, TrustedBiddingData trustedBiddingSignals) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof CustomAudience) {
            return Intrinsics.areEqual(this.buyer, ((CustomAudience) other).buyer) && Intrinsics.areEqual(this.name, ((CustomAudience) other).name) && Intrinsics.areEqual(this.activationTime, ((CustomAudience) other).activationTime) && Intrinsics.areEqual(this.expirationTime, ((CustomAudience) other).expirationTime) && Intrinsics.areEqual(this.dailyUpdateUri, ((CustomAudience) other).dailyUpdateUri) && Intrinsics.areEqual(this.userBiddingSignals, ((CustomAudience) other).userBiddingSignals) && Intrinsics.areEqual(this.trustedBiddingSignals, ((CustomAudience) other).trustedBiddingSignals) && Intrinsics.areEqual(this.ads, ((CustomAudience) other).ads);
        }
        return false;
    }

    public int hashCode() {
        int hash = this.buyer.hashCode();
        int hash2 = ((hash * 31) + this.name.hashCode()) * 31;
        Instant instant = this.activationTime;
        int hash3 = (hash2 + (instant != null ? instant.hashCode() : 0)) * 31;
        Instant instant2 = this.expirationTime;
        int hash4 = (((hash3 + (instant2 != null ? instant2.hashCode() : 0)) * 31) + this.dailyUpdateUri.hashCode()) * 31;
        AdSelectionSignals adSelectionSignals = this.userBiddingSignals;
        int hash5 = (hash4 + (adSelectionSignals != null ? adSelectionSignals.hashCode() : 0)) * 31;
        TrustedBiddingData trustedBiddingData = this.trustedBiddingSignals;
        return ((((hash5 + (trustedBiddingData != null ? trustedBiddingData.hashCode() : 0)) * 31) + this.biddingLogicUri.hashCode()) * 31) + this.ads.hashCode();
    }
    ...
    public static final class Builder {
        ...
        public final Builder setBuyer(AdTechIdentifier buyer) {
            Intrinsics.checkNotNullParameter(buyer, "buyer");
            Builder $this$setBuyer_u24lambda_u240 = this;
            $this$setBuyer_u24lambda_u240.buyer = buyer;
            return this;
        }

        public final Builder setName(String name) {
            Intrinsics.checkNotNullParameter(name, "name");
            Builder $this$setName_u24lambda_u241 = this;
            $this$setName_u24lambda_u241.name = name;
            return this;
        }

        public final Builder setActivationTime(Instant activationTime) {
            Intrinsics.checkNotNullParameter(activationTime, "activationTime");
            Builder $this$setActivationTime_u24lambda_u242 = this;
            $this$setActivationTime_u24lambda_u242.activationTime = activationTime;
            return this;
        }

        public final Builder setExpirationTime(Instant expirationTime) {
            Intrinsics.checkNotNullParameter(expirationTime, "expirationTime");
            Builder $this$setExpirationTime_u24lambda_u243 = this;
            $this$setExpirationTime_u24lambda_u243.expirationTime = expirationTime;
            return this;
        }

        public final Builder setDailyUpdateUri(Uri dailyUpdateUri) {
            Intrinsics.checkNotNullParameter(dailyUpdateUri, "dailyUpdateUri");
            Builder $this$setDailyUpdateUri_u24lambda_u244 = this;
            $this$setDailyUpdateUri_u24lambda_u244.dailyUpdateUri = dailyUpdateUri;
            return this;
        }

        public final Builder setUserBiddingSignals(AdSelectionSignals userBiddingSignals) {
            Intrinsics.checkNotNullParameter(userBiddingSignals, "userBiddingSignals");
            Builder $this$setUserBiddingSignals_u24lambda_u245 = this;
            $this$setUserBiddingSignals_u24lambda_u245.userBiddingSignals = userBiddingSignals;
            return this;
        }

        public final Builder setTrustedBiddingData(TrustedBiddingData trustedBiddingSignals) {
            Intrinsics.checkNotNullParameter(trustedBiddingSignals, "trustedBiddingSignals");
            Builder $this$setTrustedBiddingData_u24lambda_u246 = this;
            $this$setTrustedBiddingData_u24lambda_u246.trustedBiddingData = trustedBiddingSignals;
            return this;
        }

        public final Builder setBiddingLogicUri(Uri biddingLogicUri) {
            Intrinsics.checkNotNullParameter(biddingLogicUri, "biddingLogicUri");
            Builder $this$setBiddingLogicUri_u24lambda_u247 = this;
            $this$setBiddingLogicUri_u24lambda_u247.biddingLogicUri = biddingLogicUri;
            return this;
        }

        public final Builder setAds(List<AdData> ads) {
            Intrinsics.checkNotNullParameter(ads, "ads");
            Builder $this$setAds_u24lambda_u248 = this;
            $this$setAds_u24lambda_u248.ads = ads;
            return this;
        }
