...
public final class TrustedBiddingData {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof TrustedBiddingData) {
            return Intrinsics.areEqual(this.trustedBiddingUri, ((TrustedBiddingData) other).trustedBiddingUri) && Intrinsics.areEqual(this.trustedBiddingKeys, ((TrustedBiddingData) other).trustedBiddingKeys);
        }
        return false;
    }
