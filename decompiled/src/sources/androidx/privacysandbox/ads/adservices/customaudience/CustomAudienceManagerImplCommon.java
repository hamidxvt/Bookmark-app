...
public class CustomAudienceManagerImplCommon extends CustomAudienceManager {
    ...
    static /* synthetic */ Object joinCustomAudience$suspendImpl(CustomAudienceManagerImplCommon $this, JoinCustomAudienceRequest request, Continuation<? super Unit> continuation) {
        CancellableContinuationImpl cancellable$iv = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        cancellable$iv.initCancellability();
        CancellableContinuationImpl continuation2 = cancellable$iv;
        $this.getCustomAudienceManager().joinCustomAudience($this.convertJoinRequest(request), new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), OutcomeReceiverKt.asOutcomeReceiver(continuation2));
    ...
    static /* synthetic */ Object fetchAndJoinCustomAudience$suspendImpl(CustomAudienceManagerImplCommon $this, FetchAndJoinCustomAudienceRequest request, Continuation<? super Unit> continuation) {
        if (AdServicesInfo.INSTANCE.adServicesVersion() >= 10 || AdServicesInfo.INSTANCE.extServicesVersionS() >= 10) {
            Object fetchAndJoinCustomAudience = Ext10Impl.INSTANCE.fetchAndJoinCustomAudience($this.customAudienceManager, request, continuation);
    ...
    static /* synthetic */ Object leaveCustomAudience$suspendImpl(CustomAudienceManagerImplCommon $this, LeaveCustomAudienceRequest request, Continuation<? super Unit> continuation) {
        CancellableContinuationImpl cancellable$iv = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        cancellable$iv.initCancellability();
        CancellableContinuationImpl continuation2 = cancellable$iv;
        $this.getCustomAudienceManager().leaveCustomAudience($this.convertLeaveRequest(request), new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), OutcomeReceiverKt.asOutcomeReceiver(continuation2));
        Object result = cancellable$iv.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended(continuation);
        }
    ...
    private final List<AdData> convertAds(List<androidx.privacysandbox.ads.adservices.common.AdData> input) {
        ...
        for (androidx.privacysandbox.ads.adservices.common.AdData ad : input) {
            result.add(ad.convertToAdServices$ads_adservices_release());
        }
        return result;
    }
    ...
    private static final class Ext10Impl {
        ...
        public static final class Companion {
            ...
            public final Object fetchAndJoinCustomAudience(android.adservices.customaudience.CustomAudienceManager customAudienceManager, FetchAndJoinCustomAudienceRequest fetchAndJoinCustomAudienceRequest, Continuation<? super Unit> continuation) {
                ...
                cancellable$iv.initCancellability();
                CancellableContinuationImpl continuation2 = cancellable$iv;
                customAudienceManager.fetchAndJoinCustomAudience(fetchAndJoinCustomAudienceRequest.convertToAdServices$ads_adservices_release(), new AdIdManagerImplCommon$$ExternalSyntheticLambda0(), OutcomeReceiverKt.asOutcomeReceiver(continuation2));
                Object result = cancellable$iv.getResult();
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(continuation);
                }
