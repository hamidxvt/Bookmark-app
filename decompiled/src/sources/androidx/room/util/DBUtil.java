...
public final class DBUtil {
    ...
    private static final String processForeignKeyCheckFailure(Cursor cursor) {
        ...
        $this$processForeignKeyCheckFailure_u24lambda_u245.append(fkParentTables.keySet().size()).append(StringUtils.LF);
        $this$processForeignKeyCheckFailure_u24lambda_u245.append("Number of rows in violation: ");
        $this$processForeignKeyCheckFailure_u24lambda_u245.append(rowCount).append(StringUtils.LF);
        ...
        for (Map.Entry entry : fkParentTables.entrySet()) {
            ...
            $this$processForeignKeyCheckFailure_u24lambda_u245.append(key).append(StringUtils.LF);
        }
