...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public boolean containsItem(long itemId) {
        return itemId >= 0 && itemId < ((long) getTabCount());
    }
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        void updateFragmentMaxLifecycle(boolean dataSetChanged) {
            ...
            if (FragmentStateAdapter.this.shouldDelayFragmentTransactions() || this.mViewPager.getScrollState() != 0 || FragmentStateAdapter.this.mFragments.isEmpty() || FragmentStateAdapter.this.getTabCount() == 0 || (currentItem = this.mViewPager.getCurrentItem()) >= FragmentStateAdapter.this.getTabCount()) {
                return;
            }
