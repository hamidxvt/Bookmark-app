...
function LiveMap({
  ...
  const buildPinEl = useCallback((o: Officer) => {
    ...
    const speed = Number(o.lastSpeedKmh ?? 0) < 3 ? 0 : Number(o.lastSpeedKmh ?? 0);
                ...
                <div style="padding:12px 16px;background:white;">
                  ...
                  <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:10px;">
                    <div style="background:linear-gradient(135deg,#fef3c7,#fef08a);border-radius:10px;padding:8px;text-align:center;border:1px solid #fde68a;">
                      <p style="font-size:16px;font-weight:800;color:#d97706;margin:0;">${Number(o.lastSpeedKmh ?? 0) < 3 ? 0 : (Number(o.lastSpeedKmh ?? 0)).toFixed(0)}</p>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm">
        ...
        {withLoc.length === 0 ? (
          ...
          />
            ...
            const speed    = rawSpeed != null && rawSpeed < 3 ? 0 : rawSpeed;
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-slate-50">
            {cleanOfficers.map(o => {
              ...
              const speed = rawSpd2 != null && rawSpd2 < 3 ? 0 : rawSpd2;
